import{S as A,u as _,k as l,W as L,R as f,t,ac as F,n as h}from"./iframe-B68zFh-R.js";import{S as y}from"./searchfield.component-Az8p-1ex.js";import{P as R}from"./popover.constants-CHY_Bn1n.js";import{D as B}from"./formfieldwrapper.constants-CnsEzOUD.js";import{I as z,A as D,a as W}from"./input.constants-BfqEqTAf.js";import"./index-D6XkU7t1.js";import"./index-CcBRSnuj.js";import"./index-nuEjS9PO.js";import{c as k,s as M}from"./commonArgTypes-BG7EqI50.js";import{h as G}from"./utils-B5QUENNQ.js";import"./index-Dmw8prTH.js";import"./index-B8ihRXBI.js";import"./index-Cq9rD79r.js";import"./index-CmSaUzO7.js";import"./index-BIlqxK9S.js";import"./preload-helper-C1FmrZbK.js";import"./input.component-Cx7NLC3Q.js";import"./index-C66Azp1h.js";import"./index-BzQX-a8H.js";import"./statusmessage.constants-aI6TPone.js";import"./index-DTWIEuIB.js";import"./popover.component-TGZ1C38d.js";import"./BackdropMixin-r0_gKnDt.js";import"./FocusTrapMixin-BbIi7yxz.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./index-RIOMtNYw.js";import"./formfieldwrapper.component-BqCQR5FV.js";import"./DisabledMixin-Cqnt9CUs.js";import"./DataAriaLabelMixin-BaR4QREq.js";import"./FormInternalsMixin-Ch7Ctk-8.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./ControlTypeMixin-ISbn_sfd.js";import"./chip.component-t3pcBsRl.js";import"./IconNameMixin-BwwTHp8W.js";import"./staticchip.component-0vrNMi_Z.js";import"./alertchip.constants-Cxt82Xm7.js";import"./button.component-B8x0XBNW.js";import"./button.utils-rNW36Ji7.js";import"./index-DTrDRi1E.js";import"./list.component-CIKerBTs.js";import"./ListNavigationMixin-DyNP5gzE.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-CKsHLKpD.js";import"./CaptureDestroyEventForChildElement-FTucl9bH.js";import"./listitem.component-DiCj7Lkc.js";const N=A`
...
`,U=[N],V=_.constructTagName("searchpopover"),g={TYPE:z.TEXT,DISPLAY_POPOVER:!1},x="searchpopover-container-triggerid",v="searchpopover-popoverid";var Y=Object.defineProperty,m=(e,o,i,$)=>{for(var r=void 0,p=e.length-1,n;p>=0;p--)(n=e[p])&&(r=n(o,i,r)||r);return r&&Y(o,i,r),r};const b=class b extends y{constructor(){super(...arguments),this.displayPopover=g.DISPLAY_POPOVER,this.placement=R.BOTTOM_START,this.popoverZIndex=void 0}get scrollContainer(){var o;return((o=this.shadowRoot)==null?void 0:o.querySelector('[part="filters-container"]'))??null}handlePopoverHidden(){var o;(this===document.activeElement||this.contains(document.activeElement))&&((o=this.inputElement)==null||o.focus())}renderInputElement(){const o=this.hasChips?"":this.placeholder;return l`<input
  ...
  </mdc-searchpopover>`},Me={title:"Widgets/searchpopover",tags:["autodocs"],component:"mdc-searchpopover",render:q,argTypes:{"display-popover":{control:"boolean"},label:{control:"text"},placeholder:{control:"text"},id:{control:"text"},name:{control:"text"},value:{control:"text"},disabled:{control:"boolean"},readonly:{control:"boolean"},maxlength:{control:"number"},minlength:{control:"number"},autocapitalize:{control:"select",options:Object.values(D)},"auto-focus-on-mount":{control:"boolean"},autocomplete:{control:"text",options:Object.values(W)},dirname:{control:"text"},pattern:{control:"text"},list:{control:"text"},size:{control:"number"},"clear-aria-label":{control:"text"},"data-aria-label":{control:"text"},"popover-aria-label":{control:"text"},...G(["prefix-text","help-text","help-text-type","required","validation-message","validity","willValidate","trailing-button","leading-icon","inputChips"]),...k,...M}},w=[{label:"Tropical",items:["Mango","Pineapple","Kiwi","Banana"]},{label:"Berries",items:["Strawberry","Blueberry","Grapes"]},{label:"Citrus",items:["Orange"]},{label:"Common",items:["Apple","Watermelon"]}],K=e=>{const o=e.value??"",i=e.selectedFilters??[],$=O.filter(r=>{const p=r.toLowerCase().includes(o.toLowerCase());if(i.length===0)return p;const n=w.filter(u=>i.includes(u.label)).some(u=>u.items.includes(r));return p&&n});return l`
    <mdc-searchpopover
      @input="${a("oninput")}"
      @change="${a("onchange")}"
      @focus="${a("onfocus")}"
...
}`,...(I=(C=d.parameters)==null?void 0:C.docs)==null?void 0:I.source}}};const Ge=["Example","WithFilters"];export{c as Example,d as WithFilters,Ge as __namedExportsOrder,Me as default};
