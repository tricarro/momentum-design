import{n as l,X as y,a7 as i,B as p,c as _,a8 as E,a9 as v,I as O,P as R,S as A,aa as C,R as B,k as u,m as F}from"./iframe-B68zFh-R.js";import{B as S}from"./buttonsimple.component-DtR-0bQJ.js";import{g as w}from"./button.utils-rNW36Ji7.js";var L=Object.defineProperty,h=(c,t,m,e)=>{for(var o=void 0,r=c.length-1,a;r>=0;r--)(a=c[r])&&(o=a(t,m,o)||o);return o&&L(t,m,o),o};const $=c=>{class t extends c{constructor(){super(...arguments),this.variant=i.VARIANT,this.color=i.COLOR,this.typeInternal=i.TYPE_INTERNAL}setVariant(e){this.setAttribute("variant",Object.values(p).includes(e)?e:i.VARIANT)}setColor(e){const o=Object.values(_).includes(e),r=this.variant===p.TERTIARY&&!Object.values(E).includes(e);!o||r?this.setAttribute("color",`${i.COLOR}`):this.setAttribute("color",e)}setSize(e){const r=this.typeInternal===v.ICON?Object.values(O).includes(e)&&!(e===O[20]&&this.variant!==p.TERTIARY):Object.values(R).includes(e);this.setAttribute("size",r?`${e}`:`${i.SIZE}`)}inferButtonType(){var x,I,k,T,z,N;const e=(I=(x=this.shadowRoot)==null?void 0:x.querySelector("slot:not([name])"))==null?void 0:I.assignedNodes().filter(n=>{var s;return n.nodeType!==Node.TEXT_NODE||((s=n.textContent)==null?void 0:s.trim())}).length,o=(T=(k=this.shadowRoot)==null?void 0:k.querySelector('slot[name="prefix"]'))==null?void 0:T.assignedNodes().filter(n=>{var s;return n.nodeType!==Node.TEXT_NODE||((s=n.textContent)==null?void 0:s.trim())}).length,r=this.prefixIcon||o&&o>0,a=(N=(z=this.shadowRoot)==null?void 0:z.querySelector('slot[name="postfix"]'))==null?void 0:N.assignedNodes().filter(n=>{var s;return n.nodeType!==Node.TEXT_NODE||((s=n.textContent)==null?void 0:s.trim())}).length,g=this.postfixIcon||a&&a>0;e&&(r||g)?(this.typeInternal=v.PILL_WITH_ICON,this.setAttribute("data-btn-type","pill-with-icon")):!e&&(r||g)?(this.typeInternal=v.ICON,this.setAttribute("data-btn-type","icon")):(this.typeInternal=v.PILL,this.setAttribute("data-btn-type","pill"))}}return h([l({type:String,attribute:"prefix-icon",reflect:!0})],t.prototype,"prefixIcon"),h([l({type:String,attribute:"postfix-icon",reflect:!0})],t.prototype,"postfixIcon"),h([l({type:String})],t.prototype,"variant"),h([l({type:String})],t.prototype,"color"),h([y()],t.prototype,"typeInternal"),t},j=A`
  :host {
...
`,U=[j];var V=Object.defineProperty,b=(c,t,m,e)=>{for(var o=void 0,r=c.length-1,a;r>=0;r--)(a=c[r])&&(o=a(t,m,o)||o);return o&&V(t,m,o),o};const f=class f extends C($(S)){constructor(){super(...arguments),this.size=i.SIZE,this.inverted=i.INVERTED,this.role=B.BUTTON}get overflowElement(){return this.buttonTextPart}update(t){super.update(t),t.has("active")&&this.inferFilledIconName(this.active),t.has("size")&&this.setSize(this.size),t.has("variant")&&(this.setVariant(this.variant),this.setColor(this.color),this.setSize(this.size)),t.has("color")&&this.setColor(this.color),t.has("typeInternal")&&this.setSize(this.size),(t.has("prefixIcon")||t.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(t){t?(this.prefixIcon&&(this.prefixFilledIconName=`${w(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${w(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}render(){return u`
    ...
    `}};f.styles=[...S.styles,...U];let d=f;b([F('slot[part="button-text"]')],d.prototype,"buttonTextPart");b([l({type:Number})],d.prototype,"size");b([l({type:Boolean,reflect:!0})],d.prototype,"inverted");b([l({type:String,reflect:!0})],d.prototype,"role");b([y()],d.prototype,"prefixFilledIconName");b([y()],d.prototype,"postfixFilledIconName");export{d as B,$ as a};
