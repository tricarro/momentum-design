import"./index-DYLHq5ML.js";import{k as g}from"./iframe-B68zFh-R.js";import{i as G}from"./manifest-774oQsuf.js";import{c as F,s as X}from"./commonArgTypes-BG7EqI50.js";import{a as q}from"./utils-B5QUENNQ.js";import{T as e,I as V,D as i}from"./badge.constants-C3cosm6A.js";import"./IconNameMixin-BwwTHp8W.js";import"./index-CcBRSnuj.js";import"./preload-helper-C1FmrZbK.js";import"./index-DcKjLdTd.js";import"./index-DTrDRi1E.js";const r=[9,99,999],j=a=>g`
  <mdc-badge
    type="${a.type}"
...
`,te={title:"Components/badge",tags:["autodocs"],component:"mdc-badge",render:j,argTypes:{type:{control:"select",options:Object.values(e)},overlay:{control:"boolean"},counter:{if:{arg:"type",eq:e.COUNTER},control:"number"},"max-counter":{if:{arg:"type",eq:e.COUNTER},control:"select",options:r},"icon-name":{if:{arg:"type",eq:e.ICON},control:"select",options:Object.keys(G)},variant:{if:{arg:"type",eq:e.ICON},control:"select",options:Object.values(V)},"aria-label":{control:"text"},...F,...X}},o={args:{type:i.TYPE,"icon-name":"placeholder-bold",variant:i.VARIANT,counter:1,"max-counter":r[1],overlay:!1}},n={args:{type:i.TYPE,"icon-name":"placeholder-bold",variant:i.VARIANT,counter:1,"max-counter":r[1]}},t={args:{type:e.ICON,"icon-name":"placeholder-bold",variant:V.PRIMARY}},c={args:{type:e.COUNTER,counter:10,"max-counter":r[1]}},d={args:{type:e.SUCCESS}},s={args:{type:e.WARNING}},m={args:{type:e.ERROR,overlay:!1}},l={render:z,args:{type:e.COUNTER,counter:1e3,"max-counter":r[2],overlay:!0}},p={render:()=>g`
  ...
  \`,
  ...hideAllControls()
}`,...(M=(w=p.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};const ce=["Example","Dot","Icon","Counter","Success","Warning","Error","Overlay","AllVariants"];export{p as AllVariants,c as Counter,n as Dot,m as Error,o as Example,t as Icon,l as Overlay,d as Success,s as Warning,ce as __namedExportsOrder,te as default};
