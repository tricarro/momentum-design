import{k as o,V as r,t as u}from"./iframe-B68zFh-R.js";import{h as Ee,a as Te,d as xe}from"./utils-B5QUENNQ.js";import"./index-D6XkU7t1.js";import"./index-BgbJOeBs.js";import"./index-BUEGE1H7.js";import"./index-BIug64jN.js";import"./index-DrDQ8qha.js";import"./index-yDK41FTK.js";import"./index-8HU9aZLc.js";import"./index-Cq9rD79r.js";import"./index-CmSaUzO7.js";import"./index-B4kWsmpl.js";import{P as p,C as fe,B as Ie,S as ke,D as t}from"./popover.constants-CHY_Bn1n.js";import"./preload-helper-C1FmrZbK.js";import"./button.component-B8x0XBNW.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./button.utils-rNW36Ji7.js";import"./index-CcBRSnuj.js";import"./index-DTrDRi1E.js";import"./FormInternalsMixin-Ch7Ctk-8.js";import"./listitem.component-DiCj7Lkc.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-CKsHLKpD.js";import"./index-nuEjS9PO.js";import"./popover.component-TGZ1C38d.js";import"./BackdropMixin-r0_gKnDt.js";import"./FocusTrapMixin-BbIi7yxz.js";import"./index-DTWIEuIB.js";import"./index-RIOMtNYw.js";import"./CaptureDestroyEventForChildElement-FTucl9bH.js";import"./DataAriaLabelMixin-BaR4QREq.js";import"./ListNavigationMixin-DyNP5gzE.js";import"./formfieldwrapper.component-BqCQR5FV.js";import"./formfieldwrapper.constants-CnsEzOUD.js";import"./statusmessage.constants-aI6TPone.js";import"./menuitemradio.constants-jfB185Vt.js";import"./menupopover.constants-DnLM0gLw.js";import"./badge.constants-C3cosm6A.js";import"./menuitem.component-ErCE-0PC.js";import"./menuitemcheckbox.constants-DAVKpMYS.js";import"./dialog.component-C7u-_JKG.js";import"./FooterMixin-DqFVjP7r.js";import"./link.constants-B54f1TYF.js";import"./list.component-CIKerBTs.js";const{action:g}=__STORYBOOK_MODULE_ACTIONS__,m=(e,n)=>o`
  <mdc-popover
    id="${e.id}"
...
`,Dt={title:"Components/popover",tags:["autodocs"],component:"mdc-popover",render:De,argTypes:{id:{control:"text"},triggerID:{control:"text"},trigger:{control:"text"},placement:{control:"select",options:Object.values(p)},offset:{if:{arg:"offset"},control:"number"},visible:{control:"boolean"},delay:{control:"text"},color:{control:"select",options:Object.values(fe)},"disable-flip":{control:"boolean"},size:{control:"boolean"},backdrop:{control:"boolean"},"z-index":{if:{arg:"z-index"},control:"number"},"show-arrow":{control:"boolean"},"close-button":{control:"boolean"},interactive:{control:"boolean"},"focus-trap":{control:"boolean"},"should-focus-trap-wrap":{control:"boolean"},"prevent-scroll":{control:"boolean"},"hide-on-blur":{control:"boolean"},"hide-on-escape":{control:"boolean"},"hide-on-outside-click":{control:"boolean"},"focus-back-to-trigger":{control:"boolean"},"append-to":{control:"text"},"element-index-to-receive-focus":{control:"number"},"close-button-aria-label":{control:"text"},"aria-label":{control:"text"},"aria-labelledby":{control:"text"},"aria-describedby":{control:"text"},role:{control:"text"},"disable-aria-expanded":{control:"boolean"},"backdrop-append-to":{control:"text"},"is-backdrop-invisible":{control:"boolean"},boundary:{control:"text"},"boundary-padding":{control:"number"},"boundary-root":{control:"select",options:Object.values(Ie)},strategy:{control:"select",options:Object.values(ke)},...Ee(["aria-label","arrowElement","hide","show","togglePopoverVisible","triggerElement","utils"])}},a={args:{id:"popover",triggerID:"popover-trigger",trigger:"click",placement:p.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"show-arrow":!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!0,interactive:t.INTERACTIVE}},v={render:Ae,args:{id:"popover-interactive",triggerID:"popover-trigger-interactive",trigger:"click",placement:p.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"focus-trap":!0,interactive:!0,"show-arrow":!0,"disable-flip":t.DISABLE_FLIP,size:!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!1,"element-index-to-receive-focus":5}},b={render:Se,args:{id:"popover-interactive-hover",triggerID:"popover-trigger-interactive-hover",trigger:"mouseenter",placement:p.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,"focus-back-to-trigger":!0,role:t.ROLE,color:t.COLOR}},h={render:we,args:{id:"popover-multiple",triggerID:"popover-trigger-multiple",trigger:"click",placement:p.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"focus-back-to-trigger":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,"show-arrow":!0,"close-button":!0,role:t.ROLE,color:t.COLOR,"keep-connected-tooltip-open":!1}},x={render:Oe,args:{id:"popover-nested",triggerID:"popover-trigger-nested",trigger:"click",placement:p.TOP,offset:t.OFFSET,"z-index":10,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,role:t.ROLE,color:t.COLOR,"focus-back-to-trigger":!0,"hide-on-outside-click":!0}},E={render:Le,args:{id:"popover-hide-on-blur",triggerID:"popover-trigger-hide-on-blur",trigger:"click",placement:p.RIGHT,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,interactive:!0,"show-arrow":!0,"hide-on-blur":!0,role:t.ROLE,color:t.COLOR}},T={render:$e,args:{id:"popover-backdrop",triggerID:"popover-trigger-backdrop",trigger:"click",placement:p.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,interactive:!0,"show-arrow":!0,backdrop:!0,"hide-on-outside-click":!0,"focus-trap":!0,role:t.ROLE,color:t.COLOR},parameters:{docs:{description:{story:o`This example shows how to use the \`backdrop\` property to create a modal popover.<br />
          ...
          not have the backdrop enabled and can be interacted with while the modal popover is open.`}}}},f={render:()=>o`
  ...
  `},k={parameters:{...xe(o`
    ...
    `}},D={args:{...a.args,placement:p.RIGHT_START,triggerID:"trigger-btn"},render:()=>o`
    ${l("popover-trigger-interactive","Click me!")}
    <mdc-popover
      id="popover"
  ...
  `},S={args:{...a.args,id:"popover-scroll-overflow",triggerID:"trigger-scroll-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,size:!0},render:e=>o`
  ...
  `},L={args:{...a.args,id:"popover-scroll-overflow",triggerID:"trigger-scroll-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,size:!0},parameters:{...xe(o` <mdc-text>
    ...
    `}};var $,y,P;a.parameters={...a.parameters,docs:{...($=a.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    id: 'popover',
...
}`,...(P=(y=a.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};var F,_,B;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(W=(j=T.parameters)==null?void 0:j.docs)==null?void 0:W.source}}};var K,J,Q;f.parameters={...f.parameters,docs:{...(K=f.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: () => html\`
    <div style="width: 10rem; height: 8rem; margin: 5rem;">
      <mdc-button id="select-button">Click me!</mdc-button>
      <mdc-popover
  ...
  \`,
  ...hideAllControls()
}`,...(Q=(J=f.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var ee,te,oe;I.parameters={...I.parameters,docs:{...(ee=I.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => html\`
    <style>
      .container {
        display: flex;
  ...
  \`
}`,...(oe=(te=I.parameters)==null?void 0:te.docs)==null?void 0:oe.source}}};var re,ne,ie;k.parameters={...k.parameters,docs:{...(re=k.parameters)==null?void 0:re.docs,source:{originalSource:`{
  parameters: {
    ...describeStory(html\`
        <mdc-text> To breakout stacking context is necessary to use append to. </mdc-text>
        <mdc-text> Trigger and popover dynamically added to the DOM </mdc-text>
...
}`,...(ie=(ne=k.parameters)==null?void 0:ne.docs)==null?void 0:ie.source}}};var ce,de,pe;D.parameters={...D.parameters,docs:{...(ce=D.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    ...Example.args,
  ...
  \`
}`,...(pe=(de=D.parameters)==null?void 0:de.docs)==null?void 0:pe.source}}};var me,le,ae;A.parameters={...A.parameters,docs:{...(me=A.parameters)==null?void 0:me.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    id: 'popover',
    placement: POPOVER_PLACEMENT.RIGHT_START,
  ...
  \`
}`,...(ae=(le=A.parameters)==null?void 0:le.docs)==null?void 0:ae.source}}};var se,ue,ge;S.parameters={...S.parameters,docs:{...(se=S.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
    ...Example.args,
  ...
  \`
}`,...(ge=(ue=S.parameters)==null?void 0:ue.docs)==null?void 0:ge.source}}};var ve,be,he;L.parameters={...L.parameters,docs:{...(ve=L.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    id: 'popover-scroll-overflow',
    triggerID: 'trigger-scroll-btn',
...
}`,...(he=(be=L.parameters)==null?void 0:be.docs)==null?void 0:he.source}}};const At=["Example","interactiveContent","interactiveHover","interactiveMultiple","nestedPopover","hideOnBlur","popoverWithBackdrop","popoverWithSelect","MultipleSingleLevelPopovers","AppendTo","NestedMenu","PopoverWithTooltipAndDialog","PopoverScrollOverflow","PopoverInChangingList"];export{k as AppendTo,a as Example,I as MultipleSingleLevelPopovers,D as NestedMenu,L as PopoverInChangingList,S as PopoverScrollOverflow,A as PopoverWithTooltipAndDialog,At as __namedExportsOrder,Dt as default,E as hideOnBlur,v as interactiveContent,b as interactiveHover,h as interactiveMultiple,x as nestedPopover,T as popoverWithBackdrop,f as popoverWithSelect};
