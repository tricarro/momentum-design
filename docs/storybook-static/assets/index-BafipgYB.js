import{S as y,a6 as k,U as T,R as f,k as o,V as p,T as d,v as u,C as x,n as c}from"./iframe-B68zFh-R.js";import{K as R,a as S,T as C,A as n}from"./KeyDownHandledMixin-BiZdIgE3.js";import{p as A}from"./index-DcKjLdTd.js";import{D as E,b as N,a as s,c as h,d as D}from"./stepper.component-DAE3V5oa.js";import"./index-CcBRSnuj.js";const _=y`
  :host {
    gap: 0.5rem;
    ...
    >`;return this.status===s.ERROR_INCOMPLETE||this.status===s.ERROR_CURRENT?o`<div part="help-text-container">
      ...
      <div part="label-container">
        ${this.label?o`<mdc-text part="label" tagname=${p.SPAN} type=${d.BODY_MIDSIZE_REGULAR}
            ...
            >`:u}
        ${this.renderHelpText()}
      </div>`}};v.styles=[...x.styles,...O];let r=v;i([c({type:String,reflect:!0})],r.prototype,"variant");i([c({type:String,reflect:!0})],r.prototype,"status");i([c({type:String,reflect:!0})],r.prototype,"label");i([c({type:String,reflect:!0,attribute:"help-text"})],r.prototype,"helpText");i([c({type:Number,reflect:!0,attribute:"step-number"})],r.prototype,"stepNumber");r.register(D);
