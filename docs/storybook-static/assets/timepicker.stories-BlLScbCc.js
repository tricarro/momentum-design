import"./index-D6XkU7t1.js";import"./index-CcBRSnuj.js";import"./index-BUEGE1H7.js";import"./index-nuEjS9PO.js";import"./index-BTazplaC.js";import{u as Xe,S as je,U as Ge,k as v,v as N,t as c,X as x,n as p,m as C}from"./iframe-B68zFh-R.js";import"./index-DTWIEuIB.js";import{D as Ye}from"./DataAriaLabelMixin-BaR4QREq.js";import{F as Je}from"./FormInternalsMixin-Ch7Ctk-8.js";import{b as h}from"./KeyDownHandledMixin-BiZdIgE3.js";import{F as K}from"./formfieldwrapper.component-BqCQR5FV.js";import{P as Qe,D as Ze,a as et}from"./popover.constants-CHY_Bn1n.js";import{c as tt,s as ot}from"./commonArgTypes-BG7EqI50.js";import{h as lt,a as T}from"./utils-B5QUENNQ.js";import{V as at}from"./formfieldwrapper.constants-CnsEzOUD.js";import"./button.component-B8x0XBNW.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./button.utils-rNW36Ji7.js";import"./preload-helper-C1FmrZbK.js";import"./index-DcKjLdTd.js";import"./index-DTrDRi1E.js";import"./listitem.component-DiCj7Lkc.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-CKsHLKpD.js";import"./popover.component-TGZ1C38d.js";import"./BackdropMixin-r0_gKnDt.js";import"./FocusTrapMixin-BbIi7yxz.js";import"./index-RIOMtNYw.js";import"./statusmessage.constants-aI6TPone.js";const it=Xe.constructTagName("timepicker"),z={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},d={TWELVE_HOUR:"12h",TWENTY_FOUR_HOUR:"24h"},X="timepicker-triggerid",j="timepicker-listbox",u={TIME_FORMAT:d.TWELVE_HOUR,INTERVAL:30,MIN_HOUR_12:1,MAX_HOUR_12:12,MIN_HOUR_24:0,MAX_HOUR_24:23,MIN_MINUTE:0,MAX_MINUTE:59,DISABLE_FLIP:!1},rt=je`
  :host {
...
`,nt=[rt,...Ge(!0)];var st=Object.defineProperty,n=(a,e,t,o)=>{for(var l=void 0,r=a.length-1,m;r>=0;r--)(m=a[r])&&(l=m(e,t,l)||l);return l&&st(e,t,l),l};const q=class q extends Je(Ye(K)){constructor(){super(...arguments),this.timeFormat=u.TIME_FORMAT,this.interval=u.INTERVAL,this.placement=Qe.BOTTOM_START,this.strategy=Ze.STRATEGY,this.disableFlip=u.DISABLE_FLIP,this.localeHoursLabel="",this.localeMinutesLabel="",this.localePeriodLabel="",this.localeHoursPlaceholder="",this.localeMinutesPlaceholder="",this.localePeriodPlaceholder="",this.localeAmLabel="",this.localePmLabel="",this.localeShowTimePickerLabel="",this.localeTimeOptionsLabel="",this.localeSpinbuttonDescription="",this.displayPopover=!1,this.internalHours="",this.internalMinutes="",this.internalPeriod="AM",this.focusedOptionIndex=-1,this.pendingDigits=""}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.parseValueToInternal(),this.syncFormValue()}).catch(e=>{this.onerror&&this.onerror(e)})}disconnectedCallback(){super.disconnectedCallback(),this.pendingDigitTimeout&&clearTimeout(this.pendingDigitTimeout)}willUpdate(e){super.willUpdate(e),e.has("value")&&!this.displayPopover&&(this.parseValueToInternal(),this.syncFormValue()),(e.has("disabled")||e.has("softDisabled")||e.has("readonly"))&&(this.disabled||this.softDisabled||this.readonly)&&(this.displayPopover=!1)}updated(e){super.updated(e),e.has("displayPopover")&&this.displayPopover&&this.focusMenuItemOnOpen()}focusMenuItemOnOpen(){this.focusedOptionIndex=this.getMenuItemFocusIndex(),this.updateComplete.then(()=>{window.requestAnimationFrame(()=>{this.focusCurrentMenuItem()})}).catch(()=>{})}getMenuItemFocusIndex(){const e=this.getTimeOptions(),t=this.internalToValue(),o=e.findIndex(l=>l.value===t);return o>=0?o:0}focusCurrentMenuItem(){var l;const e=(l=this.shadowRoot)==null?void 0:l.querySelector(`#${j}`);if(!e)return;const o=e.querySelectorAll("mdc-option")[this.focusedOptionIndex];o&&(o.focus({preventScroll:!0}),o.scrollIntoView({block:"nearest"}))}formResetCallback(){this.value="",this.internalHours="",this.internalMinutes="",this.internalPeriod="AM",this.syncFormValue(),this.requestUpdate()}formStateRestoreCallback(e){this.value=e,this.parseValueToInternal()}parseValueToInternal(){if(!this.value){this.internalHours="",this.internalMinutes="",this.internalPeriod="AM";return}const e=this.value.match(/^(\d{1,2}):(\d{2})$/);if(!e)return;const t=parseInt(e[1],10),o=parseInt(e[2],10);t<0||t>23||o<0||o>59||(this.internalMinutes=String(o).padStart(2,"0"),this.timeFormat===d.TWELVE_HOUR?t===0?(this.internalPeriod="AM",this.internalHours="12"):t<12?(this.internalPeriod="AM",this.internalHours=String(t).padStart(2,"0")):t===12?(this.internalPeriod="PM",this.internalHours="12"):(this.internalPeriod="PM",this.internalHours=String(t-12).padStart(2,"0")):this.internalHours=String(t).padStart(2,"0"))}internalToValue(){if(!this.internalHours||!this.internalMinutes)return"";let e=parseInt(this.internalHours,10);return this.timeFormat===d.TWELVE_HOUR&&(this.internalPeriod==="AM"?e=e===12?0:e:e=e===12?12:e+12),`${String(e).padStart(2,"0")}:${this.internalMinutes}`}syncFormValue(){const e=this.internalToValue();this.internals.setFormValue(e||this.value)}commitValue(){const e=this.internalToValue();e&&e!==this.value&&(this.value=e,this.syncFormValue(),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},composed:!0,bubbles:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},composed:!0,bubbles:!0})))}getTimeOptions(){const e=[],t=Math.max(1,Math.min(this.interval,60));for(let o=0;o<24*60;o+=t){const l=Math.floor(o/60),r=o%60,m=`${String(l).padStart(2,"0")}:${String(r).padStart(2,"0")}`;let s;if(this.timeFormat===d.TWELVE_HOUR){const f=l<12?this.localeAmLabel:this.localePmLabel;let g=l%12;g===0&&(g=12);const M=String(r).padStart(2,"0");s=`${g}:${M} ${f}`}else s=`${l}:${String(r).padStart(2,"0")}`;const b=!this.min||m>=this.min,y=!this.max||m<=this.max;b&&y&&e.push({label:s,value:m})}return e}handleOptionClick(e){var t;this.value=e,this.parseValueToInternal(),this.displayPopover=!1,this.syncFormValue(),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},composed:!0,bubbles:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},composed:!0,bubbles:!0})),(t=this.dropdownButton)==null||t.focus()}handleDropdownClick(e){this.disabled||this.softDisabled||this.readonly||(this.displayPopover=!this.displayPopover,e.stopPropagation())}handleBaseContainerClick(e){var o,l,r;if(this.disabled||this.softDisabled||this.readonly)return;const t=e.target;if(t.getAttribute("role")!=="spinbutton"){if(t.getAttribute("part")==="base-container"||t.getAttribute("part")==="spinbutton-group"){this.displayPopover=!this.displayPopover,(o=this.dropdownButton)==null||o.focus(),e.stopPropagation();return}(l=this.hoursInput)==null||l.focus(),(r=this.hoursInput)==null||r.select()}}handleBaseKeydown(e){var t;this.disabled||this.softDisabled||this.readonly||e.key===h.ESCAPE&&this.displayPopover&&(this.displayPopover=!1,(t=this.dropdownButton)==null||t.focus(),e.preventDefault(),e.stopPropagation())}handleListboxKeydown(e){var l;const t=this.getTimeOptions(),o=t.length;if(o!==0)switch(e.key){case h.ARROW_DOWN:{e.preventDefault(),e.stopPropagation(),this.focusedOptionIndex=(this.focusedOptionIndex+1)%o,this.focusCurrentMenuItem();break}case h.ARROW_UP:{e.preventDefault(),e.stopPropagation(),this.focusedOptionIndex=(this.focusedOptionIndex-1+o)%o,this.focusCurrentMenuItem();break}case h.ENTER:{e.preventDefault(),e.stopPropagation(),this.focusedOptionIndex>=0&&this.focusedOptionIndex<o&&this.handleOptionClick(t[this.focusedOptionIndex].value);break}case h.ESCAPE:{e.preventDefault(),e.stopPropagation(),this.displayPopover=!1,(l=this.dropdownButton)==null||l.focus();break}}}handleHoursKeydown(e){this.handleSpinbuttonKeydown(e,"hours")}handleMinutesKeydown(e){this.handleSpinbuttonKeydown(e,"minutes")}handlePeriodKeydown(e){var t,o;switch(e.key){case h.ARROW_UP:case h.ARROW_DOWN:e.preventDefault(),this.internalPeriod=this.internalPeriod==="AM"?"PM":"AM",this.commitValue(),this.requestUpdate();break;case h.TAB:break;case h.ARROW_LEFT:e.preventDefault(),(t=this.minutesInput)==null||t.focus(),(o=this.minutesInput)==null||o.select();break;default:{e.preventDefault();const l=this.localeAmLabel.charAt(0).toLowerCase(),r=this.localePmLabel.charAt(0).toLowerCase(),m=e.key.toLowerCase();m===l?(this.internalPeriod="AM",this.commitValue(),this.requestUpdate()):m===r&&(this.internalPeriod="PM",this.commitValue(),this.requestUpdate());break}}}handleSpinbuttonKeydown(e,t){var b,y,f,g,M,B;const o=this.timeFormat===d.TWELVE_HOUR;let l,r;t==="hours"?(l=o?u.MIN_HOUR_12:u.MIN_HOUR_24,r=o?u.MAX_HOUR_12:u.MAX_HOUR_24):(l=u.MIN_MINUTE,r=u.MAX_MINUTE);const m=t==="hours"?this.internalHours:this.internalMinutes;let s=m?parseInt(m,10):l;switch(e.key){case h.ARROW_UP:{e.preventDefault(),s=s>=r?l:s+1,this.setSpinbuttonValue(t,s),this.commitValue();break}case h.ARROW_DOWN:{e.preventDefault(),s=s<=l?r:s-1,this.setSpinbuttonValue(t,s),this.commitValue();break}case h.ARROW_RIGHT:{e.preventDefault(),t==="hours"?((b=this.minutesInput)==null||b.focus(),(y=this.minutesInput)==null||y.select()):o&&((f=this.periodInput)==null||f.focus(),(g=this.periodInput)==null||g.select());break}case h.ARROW_LEFT:{e.preventDefault(),t==="minutes"&&((M=this.hoursInput)==null||M.focus(),(B=this.hoursInput)==null||B.select());break}case h.TAB:break;default:{/^\d$/.test(e.key)?(e.preventDefault(),this.handleDigitInput(e.key,t,l,r)):e.preventDefault();break}}}handleDigitInput(e,t,o,l){if(this.pendingDigitTimeout&&clearTimeout(this.pendingDigitTimeout),this.pendingDigits+=e,this.pendingDigits.length>=2){let r=parseInt(this.pendingDigits,10);r>l&&(r=l),r<o&&(r=o),this.setSpinbuttonValue(t,r),this.pendingDigits="",this.commitValue(),this.advanceToNextField(t)}else{const r=parseInt(this.pendingDigits,10),m=Math.floor(l/10);if(r>m){let s=r;s>l&&(s=l),s<o&&(s=o),this.setSpinbuttonValue(t,s),this.pendingDigits="",this.commitValue(),this.advanceToNextField(t)}else this.setSpinbuttonValue(t,r),this.pendingDigitTimeout=setTimeout(()=>{let s=r;s<o&&(s=o),this.setSpinbuttonValue(t,s),this.pendingDigits="",this.commitValue(),this.advanceToNextField(t)},1e3)}}setSpinbuttonValue(e,t){const o=String(t).padStart(2,"0");e==="hours"?this.internalHours=o:this.internalMinutes=o,this.requestUpdate()}advanceToNextField(e){e==="hours"?this.updateComplete.then(()=>{var t,o;(t=this.minutesInput)==null||t.focus(),(o=this.minutesInput)==null||o.select()}).catch(()=>{}):this.timeFormat===d.TWELVE_HOUR&&this.updateComplete.then(()=>{var t,o;(t=this.periodInput)==null||t.focus(),(o=this.periodInput)==null||o.select()}).catch(()=>{})}handleSpinbuttonFocus(e){e.target.select(),this.pendingDigits="",this.pendingDigitTimeout&&clearTimeout(this.pendingDigitTimeout)}get displayPeriod(){return this.internalPeriod==="AM"?this.localeAmLabel:this.localePmLabel}get hoursPlaceholder(){return this.localeHoursPlaceholder}get minutesPlaceholder(){return this.localeMinutesPlaceholder}get periodPlaceholder(){return this.localePeriodPlaceholder}renderTimeOptions(){const e=this.getTimeOptions(),t=this.internalToValue();return e.map(o=>v`
        ...
        ></mdc-option>
      `)}render(){const e=this.timeFormat===d.TWELVE_HOUR,t=e?u.MIN_HOUR_12:u.MIN_HOUR_24,o=e?u.MAX_HOUR_12:u.MAX_HOUR_24;return v`
      ${this.renderLabel()}
      <div part="container">
        <div
          id="${X}"
  ...
  ></mdc-timepicker>
`,Wt={title:"Components/timepicker",tags:["autodocs"],component:"mdc-timepicker",render:ct,argTypes:{label:{control:"text"},"time-format":{control:"select",options:Object.values(d)},interval:{control:"number"},required:{control:"boolean"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${G.map(a=>`'${a}'`).join(", ")}.`,options:G},min:{control:"text"},max:{control:"text"},"append-to":{control:"text"},"backdrop-append-to":{control:"text"},"locale-hours-label":{control:"text"},"locale-minutes-label":{control:"text"},"locale-period-label":{control:"text"},"locale-hours-placeholder":{control:"text"},"locale-minutes-placeholder":{control:"text"},"locale-period-placeholder":{control:"text"},"locale-am-label":{control:"text"},"locale-pm-label":{control:"text"},"locale-show-time-picker-label":{control:"text"},"locale-time-options-label":{control:"text"},"locale-spinbutton-description":{control:"text"},...lt(["value","validation-message","validity","willValidate"]),...tt,...ot}},k={"locale-hours-label":"hours","locale-minutes-label":"minutes","locale-period-label":"period","locale-hours-placeholder":"hh","locale-minutes-placeholder":"mm","locale-period-placeholder":"--","locale-am-label":"AM","locale-pm-label":"PM","locale-show-time-picker-label":"Show time picker","locale-time-options-label":"Time options","locale-spinbutton-description":"To set value, use the up/down arrow keys or type a value"},w={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,interval:30,required:!0,...k}},S={args:{label:"Start time",value:"20:30","time-format":d.TWENTY_FOUR_HOUR,interval:30,required:!0,...k}},$={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,interval:15,required:!0,...k}},A={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,required:!0,"help-text":"Time will be adjusted to attendee's timezone",...k}},E={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,required:!0,"help-text":"Please select a valid time","help-text-type":"error",...k}},O={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,required:!0,"help-text":"This time may conflict with another event","help-text-type":"warning",...k}},P={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,required:!0,"help-text":"Time confirmed","help-text-type":"success",...k}},I={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,disabled:!0,...k}},R={args:{label:"Start time",value:"08:30","time-format":d.TWELVE_HOUR,readonly:!0,...k}},_={args:{label:"Meeting time",value:"09:00","time-format":d.TWELVE_HOUR,required:!0,min:"08:00",max:"17:00","help-text":"Select a time between 8:00 AM and 5:00 PM",...k}},L={render:()=>v`
  ...
  `,...T()},V={render:()=>{const a="08:30";return v`
      <mdc-timepicker
        ...
        min="08:30"
        max="17:00"
        .optionLabelFormatter="${(t,o)=>{const[l,r]=a.split(":").map(Number),[m,s]=o.split(":").map(Number),b=m*60+s-(l*60+r);if(b<=0)return t;const y=Math.floor(b/60),f=b%60,g=y>0?`${y}h ${f>0?`${f}m`:""}`.trim():`${f}m`;return`${t} (${g})`}}"
        locale-hours-label="hours"
        locale-minutes-label="minutes"
        locale-period-label="period"
        locale-hours-placeholder="hh"
...
}`,...(pe=(ce=E.parameters)==null?void 0:ce.docs)==null?void 0:pe.source}}};var me,de,ue;O.parameters={...O.parameters,docs:{...(me=O.parameters)==null?void 0:me.docs,source:{originalSource:`{
  args: {
    label: 'Start time',
    value: '08:30',
    'time-format': TIME_FORMAT.TWELVE_HOUR,
...
}`,...(ue=(de=O.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};var he,be,fe;P.parameters={...P.parameters,docs:{...(he=P.parameters)==null?void 0:he.docs,source:{originalSource:`{
  args: {
    label: 'Start time',
    value: '08:30',
    'time-format': TIME_FORMAT.TWELVE_HOUR,
