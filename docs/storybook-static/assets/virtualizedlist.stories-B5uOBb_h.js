 ...
 */const oe="important",ge=" !"+oe,ve=le(class extends me{constructor(s){var e;if(super(s),s.type!==de.ATTRIBUTE||s.name!=="style"||((e=s.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(s){return Object.keys(s).reduce((e,t)=>{const a=s[t];return a==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(s,[e]){const{style:t}=s.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const a of this.ft)e[a]==null&&(this.ft.delete(a),a.includes("-")?t.removeProperty(a):t[a]=null);for(const a in e){const i=e[a];if(i!=null){this.ft.add(a);const r=typeof i=="string"&&i.endsWith(ge);a.includes("-")||r?t.setProperty(a,r?i.slice(0,-11):i,r?oe:""):t[a]=i}}return ce}});var ye=Object.defineProperty,S=(s,e,t,a)=>{for(var i=void 0,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=o(e,t,i)||i);return i&&ye(e,t,i),i};class u extends h{constructor(){super(...arguments),this.chatMessages={msg_001:{name:"Alice Johnson",message:"Hey team! Just finished the quarterly report. Ready for review."},msg_002:{name:"Bob Smith",message:"Great work Alice! I'll take a look this afternoon."},msg_003:{name:"Carol Davis",message:"Perfect timing. We can discuss it in tomorrow's standup."},msg_004:{name:"Alice Johnson",message:"Sounds good! Also, anyone know if the client meeting is still at 3pm?",parent:"msg_001"},msg_005:{name:"Bob Smith",message:"Yes, still at 3pm. I'll send the calendar invite.",parent:"msg_001"},msg_006:{name:"David Wilson",message:"Morning everyone! Can someone help me with the API documentation?"},msg_007:{name:"Emma Brown",message:"Good morning! What specific part are you struggling with?"},msg_008:{name:"David Wilson",message:"I need to understand the authentication flow for the new endpoints.",parent:"msg_006"},msg_009:{name:"Frank Miller",message:"I can help with that! Let me share the updated docs.",parent:"msg_006"},msg_010:{name:"Emma Brown",message:"Frank has the latest version, mine might be outdated.",parent:"msg_006"},msg_011:{name:"Carol Davis",message:"Quick question - has anyone tested the new deployment pipeline?"},msg_012:{name:"Bob Smith",message:"I ran it yesterday, worked perfectly! No issues on my end."},msg_013:{name:"Alice Johnson",message:"Same here. The performance improvements are noticeable."},msg_014:{name:"Carol Davis",message:"Excellent! Should we roll it out to staging then?",parent:"msg_011"},msg_015:{name:"Alice Johnson",message:"I think we're ready. Bob, what do you think?",parent:"msg_011"},msg_016:{name:"Bob Smith",message:"Let's do it! I can handle the deployment this evening.",parent:"msg_011"},msg_017:{name:"Frank Miller",message:"Just pushed the hotfix for the login issue. Please test when you can."},msg_018:{name:"Emma Brown",message:"Thanks Frank! I'll test it right now."},msg_019:{name:"David Wilson",message:"Login is working perfectly on my end now. Great job!"},msg_020:{name:"Frank Miller",message:"Awesome! The fix was simpler than I thought.",parent:"msg_017"},msg_021:{name:"Bob Smith",message:"Should we backport this to the release branch?",parent:"msg_017"},msg_022:{name:"Alice Johnson",message:"Yes, definitely. This was blocking our demo tomorrow.",parent:"msg_017"},msg_023:{name:"Emma Brown",message:"Hey team, reminder that code freeze is at 5pm today for the sprint."},msg_024:{name:"Carol Davis",message:"Perfect timing! I just submitted my last PR."},msg_025:{name:"David Wilson",message:"Mine is still in review. Carol, could you take a look?"},msg_026:{name:"Carol Davis",message:"Sure! Send me the link and I'll review it now.",parent:"msg_025"},msg_027:{name:"Bob Smith",message:"I can also help with reviews if needed.",parent:"msg_025"},msg_028:{name:"Frank Miller",message:"Does anyone know if the database migration is scheduled for tonight?"},msg_029:{name:"Emma Brown",message:"Yes, it's scheduled for 11pm. I'll be monitoring it."},msg_030:{name:"Alice Johnson",message:"I can stay online too in case we need to rollback."},msg_031:{name:"Frank Miller",message:"Great! I'll prepare the rollback scripts just in case.",parent:"msg_028"},msg_032:{name:"Bob Smith",message:"Should we create a war room channel for tonight?",parent:"msg_028"},msg_033:{name:"Emma Brown",message:"Good idea! I'll set it up and invite everyone.",parent:"msg_028"},msg_034:{name:"Grace Lee",message:"Just joined the team! Excited to work with everyone. 👋"},msg_035:{name:"Alice Johnson",message:"Welcome Grace! Great to have you on board!"},msg_036:{name:"Bob Smith",message:"Welcome! Let me know if you need help getting set up."},msg_037:{name:"Grace Lee",message:"Thanks everyone! Alice, could you help me with the development environment setup?",parent:"msg_034"},msg_038:{name:"Alice Johnson",message:"Absolutely! I'll send you the setup guide and we can pair tomorrow.",parent:"msg_034"},msg_039:{name:"Carol Davis",message:"Grace, I've added you to all the relevant Slack channels too.",parent:"msg_034"},msg_040:{name:"David Wilson",message:"Quick update: the API rate limiting is now live in production."},msg_041:{name:"Frank Miller",message:"Nice! Are we seeing any impact on performance?"},msg_042:{name:"Emma Brown",message:"Monitoring shows everything looks good so far."},msg_043:{name:"David Wilson",message:"Perfect! The new limits should prevent the timeout issues we had last week.",parent:"msg_040"},msg_044:{name:"Bob Smith",message:"Great work David! This was a critical fix.",parent:"msg_040"},msg_045:{name:"Carol Davis",message:"Thanks everyone! This has been a productive week."},msg_046:{name:"Grace Lee",message:"Looking forward to contributing next week!"},msg_047:{name:"Alice Johnson",message:"Have a great weekend everyone!"},msg_048:{name:"Frank Miller",message:"See you all on Monday! 🎉"},msg_049:{name:"Emma Brown",message:"One last thing - don't forget the retrospective is moved to Tuesday."},msg_050:{name:"Bob Smith",message:"Thanks for the reminder! I'll update my calendar."},msg_051:{name:"Carol Davis",message:"Same here. What time was it again?",parent:"msg_049"},msg_052:{name:"Emma Brown",message:"2pm, right after the sprint planning meeting.",parent:"msg_049"},msg_053:{name:"Grace Lee",message:"Should I join the retrospective even though I just started?",parent:"msg_049"},msg_054:{name:"Alice Johnson",message:"Absolutely! It's a great way to learn about our process.",parent:"msg_049"}},this.listItems=this.getOrderedMessageKeys(),this.virtualData={virtualItems:[]},this.virtualizerProps={count:this.listItems.length,estimateSize:()=>48,getItemKey:e=>this.listItems[e]},this.textareaValue="",this.messageCounter=54,this.textareaRef=re(),this.randomMessages=["Just finished reviewing the latest pull request.","The build is now passing on all environments.","Quick reminder about tomorrow's team meeting.","I've updated the documentation with the latest changes.","The performance metrics look great this week!","Does anyone have time to pair on this feature?","Just deployed the hotfix to production.","The client feedback has been very positive.","I'll be working from home tomorrow.","Great work on the sprint demo today!","The new feature is ready for QA testing.","Coffee break anyone? ☕","The integration tests are now automated.","Thanks for the code review feedback!","The database migration completed successfully."],this.teamMembers=["Alice Johnson","Bob Smith","Carol Davis","David Wilson","Emma Brown","Frank Miller","Grace Lee"],this.handleTextareaKeyDown=e=>{e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),this.sendMessage())},this.handleTextareaInput=e=>{const t=e.target;this.textareaValue=t.value},this.handleVirtualItemsChange=e=>{this.virtualData=e.detail}}getOrderedMessageKeys(){const e=Object.keys(this.chatMessages),t=e.filter(i=>!this.chatMessages[i].parent),a=[];return t.forEach(i=>{a.push(i);const r=e.filter(o=>this.chatMessages[o].parent===i);a.push(...r)}),a}connectedCallback(){super.connectedCallback(),this.startRandomMessageTimer()}disconnectedCallback(){super.disconnectedCallback(),this.stopRandomMessageTimer()}startRandomMessageTimer(){this.randomMessageTimer=window.setInterval(()=>{this.addRandomMessage()},5e3)}stopRandomMessageTimer(){this.randomMessageTimer&&(clearInterval(this.randomMessageTimer),this.randomMessageTimer=void 0)}addRandomMessage(){const e=this.randomMessages[Math.floor(Math.random()*this.randomMessages.length)],t=this.teamMembers[Math.floor(Math.random()*this.teamMembers.length)],a=`msg_${String(this.messageCounter+1).padStart(3,"0")}`;let i;const r=Object.keys(this.chatMessages).filter(o=>!this.chatMessages[o].parent).slice(-10);r.length>0&&(i=r[Math.floor(Math.random()*r.length)]),this.messageCounter+=1,this.chatMessages={...this.chatMessages,[a]:{name:t,message:e,...i&&{parent:i}}}}sendMessage(){if(this.textareaValue.trim()){const e=`msg_${String(this.messageCounter+1).padStart(3,"0")}`;if(this.messageCounter+=1,this.chatMessages={...this.chatMessages,[e]:{name:"You",message:this.textareaValue.trim()}},this.textareaValue="",this.textareaRef.value){const t=this.textareaRef.value.querySelector("textarea");t&&(t.value="",t.focus())}}}update(e){super.update(e),e.has("chatMessages")&&(this.listItems=this.getOrderedMessageKeys(),this.virtualizerProps={count:this.listItems.length,estimateSize:()=>48,getItemKey:t=>this.listItems[t]})}generateListItem({index:e}){const t=this.chatMessages[this.listItems[e]];return n`
    ...
    `}}S([l()],u.prototype,"chatMessages");S([l()],u.prototype,"virtualData");S([l()],u.prototype,"virtualizerProps");S([l()],u.prototype,"textareaValue");u.register("mdc-virtualizedlist-chat-example");var fe=Object.defineProperty,A=(s,e,t,a)=>{for(var i=void 0,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=o(e,t,i)||i);return i&&fe(e,t,i),i};class $ extends h{constructor(){super(...arguments),this.listItems=new Array(20).fill(!0).map((e,t)=>`list item number ${t}`),this.virtualData={virtualItems:[]},this.virtualizerProps={count:0,estimateSize:()=>0,getItemKey:e=>this.listItems[e]},this.counter=this.listItems.length,this.handleVirtualItemsChange=e=>{this.virtualData=e.detail}}connectedCallback(){super.connectedCallback(),this.updateVirtualProps()}generateListItem(e,t){return n`
    ...
    `}addItem(e,t=1){const a=new Array(t).fill(!0).map(()=>{const i=`list item number ${this.counter}`;return this.counter+=1,i});e===void 0?this.listItems=[...this.listItems,...a]:this.listItems=[...this.listItems.slice(0,e),...a,...this.listItems.slice(e,this.listItems.length)],this.updateVirtualProps()}removeItem(e){e===void 0?this.listItems=this.listItems.slice(0,-1):this.listItems=[...this.listItems.slice(0,e),...this.listItems.slice(e+1,this.listItems.length)],this.updateVirtualProps()}updateVirtualProps(){this.virtualizerProps={count:this.listItems.length,estimateSize:()=>44,getItemKey:e=>this.listItems[e]}}render(){return n`
      <div id="VirtualizedDynamicList--wrapper">
        <mdc-virtualizedlist
          .virtualizerProps=${this.virtualizerProps}
          @virtualitemschange=${this.handleVirtualItemsChange}
    ...
    `}createRenderRoot(){return this}}A([l()],$.prototype,"listItems");A([l()],$.prototype,"virtualData");A([l()],$.prototype,"virtualizerProps");$.register("mdc-virtualizeddynamiclist");var be=Object.defineProperty,T=(s,e,t,a)=>{for(var i=void 0,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=o(e,t,i)||i);return i&&be(e,t,i),i};const D=["Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's ","standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make ","a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, ","remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing "," Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions ","of Lorem Ipsum."].join(" ").split(" "),v=(s,e)=>s+Math.floor(Math.random()*e);class C extends h{constructor(){super(...arguments),this.listItems=[],this.virtualData={virtualItems:[]},this.virtualizerProps={useAnimationFrameWithResizeObserver:!0,count:0,estimateSize:()=>36,getItemKey:e=>{var t;return(t=this.listItems[e])==null?void 0:t.key}},this.virtualizerRef=re(),this.counter=0,this.isClippyNext=!1,this.addChunks=()=>{var r,o;clearTimeout(this.timerId);const e=v(2,30);let t=new Array(e).fill(!0).map(()=>D[v(0,D.length-1)]).join(" ").replace(/ +/gm," ").trim();const a=v(0,10);t+=a>6?`.
`:"",t+=a>8?`
`:"";const i=(o=(r=this.listItems.at(-1))==null?void 0:r.data)==null?void 0:o.at(-1);(!i||i===`
...
}`,...(O=(B=b.parameters)==null?void 0:B.docs)==null?void 0:O.source}}};var G,j,K;I.parameters={...I.parameters,docs:{...(G=I.parameters)==null?void 0:G.docs,source:{originalSource:`{
  argTypes: {
...
}`,...(K=(j=I.parameters)==null?void 0:j.docs)==null?void 0:K.source}}};var F,N,J;w.parameters={...w.parameters,docs:{...(F=w.parameters)==null?void 0:F.docs,source:{originalSource:"{\n  render: () => html` <mdc-virtualizeddynamiclist></mdc-virtualizeddynamiclist>`\n}",...(J=(N=w.parameters)==null?void 0:N.docs)==null?void 0:J.source}}};var q,U,H;z.parameters={...z.parameters,docs:{...(q=z.parameters)==null?void 0:q.docs,source:{originalSource:"{\n  render: () => html` <mdc-virtualizedlist-chat-example></mdc-virtualizedlist-chat-example>`\n}",...(H=(U=z.parameters)==null?void 0:U.docs)==null?void 0:H.source}}};var Q,Y,X;_.parameters={..._.parameters,docs:{...(Q=_.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(X=(Y=_.parameters)==null?void 0:Y.docs)==null?void 0:X.source}}};var Z,ee,te;k.parameters={...k.parameters,docs:{...(Z=k.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: html\`<p>
...
}`,...(te=(ee=k.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ie,se,ae;x.parameters={...x.parameters,docs:{...(ie=x.parameters)==null?void 0:ie.docs,source:{originalSource:"{\n  render: () => html` <mdc-virtualizedwrapperwithheaders></mdc-virtualizedwrapperwithheaders>`\n}",...(ae=(se=x.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};const gt=["Example","Interactive","InteractiveStartAtBottom","Dynamic","Chat","DynamicContent","WithPaddingAndGaps","WithHeaders"];export{z as Chat,w as Dynamic,_ as DynamicContent,f as Example,b as Interactive,I as InteractiveStartAtBottom,x as WithHeaders,k as WithPaddingAndGaps,gt as __namedExportsOrder,ut as default};
