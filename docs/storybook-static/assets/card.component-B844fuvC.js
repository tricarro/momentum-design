import{v as m,k as l,n as o,S as g,a6 as b,B as f,C as h,L as y}from"./iframe-B68zFh-R.js";import{D as a,F as v}from"./FooterMixin-DqFVjP7r.js";var T=Object.defineProperty,i=(n,t,r,u)=>{for(var e=void 0,s=n.length-1,d;s>=0;s--)(d=n[s])&&(e=d(t,r,e)||e);return e&&T(t,r,e),e};const x=n=>{class t extends n{constructor(){super(...arguments),this.cardTitle="",this.subtitle="",this.imageSrc="",this.imageAlt="",this.variant=a.VARIANT,this.orientation=a.ORIENTATION,this.titleTagName=a.TAGNAME,this.subtitleTagName=a.TAGNAME}renderImage(){return this.imageSrc?l`<div part="image-wrapper">
        ...
        <slot name="title">
          ${this.cardTitle?l`<mdc-text part="title" type="${a.TITLE_TYPE}" tagname="${this.titleTagName}"
...
`,N=[b,$];var S=Object.defineProperty,I=(n,t,r,u)=>{for(var e=void 0,s=n.length-1,d;s>=0;s--)(d=n[s])&&(e=d(t,r,e)||e);return e&&S(t,r,e),e};const c=class c extends x(v(h)){constructor(){super(...arguments),this.handleIconButtons=()=>{var t;(t=this.iconButtons)==null||t.forEach(r=>{r.matches(a.BUTTON)&&(r.setAttribute("variant",f.TERTIARY),r.setAttribute("size","32"))})}}update(t){super.update(t),t.has("variant")&&this.updateFooterButtonColors(this.variant)}renderHeader(){return l`<div part="header">
    ...
    `}};c.styles=[...h.styles,...N];let p=c;I([y({slot:"icon-button"})],p.prototype,"iconButtons");export{p as C,x as a};
