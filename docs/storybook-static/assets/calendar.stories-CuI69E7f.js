import{S as a}from"./index-C6-mMcSM.js";import{k as d,t as o}from"./iframe-B68zFh-R.js";import{c as $,s as _}from"./commonArgTypes-BG7EqI50.js";import{a as U}from"./utils-B5QUENNQ.js";import"./index-D6XkU7t1.js";import"./button.component-B8x0XBNW.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./button.utils-rNW36Ji7.js";import"./index-CcBRSnuj.js";import"./preload-helper-C1FmrZbK.js";import"./index-DTrDRi1E.js";const A=e=>d`
  <mdc-calendar
    value="${o(e.value)}"
...
`,Q={title:"Components/calendar",tags:["autodocs"],component:"mdc-calendar",render:A,argTypes:{value:{control:"text",description:"Selected date as ISO string (yyyy-mm-dd)"},"end-value":{control:"text",description:"End date for range selection (ISO string)"},"selection-mode":{control:"select",options:Object.values(a),description:"Selection mode: single, week, or range"},locale:{control:"text",description:"BCP 47 locale string"},min:{control:"text",description:"Minimum selectable date (ISO string)"},max:{control:"text",description:"Maximum selectable date (ISO string)"},"show-today-button":{control:"boolean",description:"Show a Today button below the calendar grid"},"locale-today-label":{control:"text",description:"Localized label for the Today button"},"locale-prev-month-label":{control:"text",description:"Localized aria-label for the previous month button"},"locale-next-month-label":{control:"text",description:"Localized aria-label for the next month button"},...$,..._}},n={args:{"selection-mode":a.SINGLE,locale:"en-US"}},l={args:{value:"2025-07-15","selection-mode":a.SINGLE,locale:"en-US"}},t={args:{value:"2025-07-13","end-value":"2025-07-19","selection-mode":a.WEEK,locale:"en-US","locale-prev-month-label":"Go to previous month","locale-next-month-label":"Go to next month"}},r={args:{value:"2025-07-10","end-value":"2025-07-20","selection-mode":a.RANGE,locale:"en-US"}},c={args:{"selection-mode":a.SINGLE,locale:"en-US",min:"2025-07-05",max:"2025-07-25"}},s={render:()=>d`
...
}`,...(I=(L=c.parameters)==null?void 0:L.docs)==null?void 0:I.source}}};var N,G,f;s.parameters={...s.parameters,docs:{...(N=s.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => html\`
    <mdc-calendar
      selection-mode="single"
      locale="fr-FR"
  ...
  \`,
  ...hideAllControls()
}`,...(f=(G=s.parameters)==null?void 0:G.docs)==null?void 0:f.source}}};var C,T,D;m.parameters={...m.parameters,docs:{...(C=m.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => html\`
    <mdc-calendar
      selection-mode="single"
      locale="de-DE"
  ...
  \`,
  ...hideAllControls()
}`,...(D=(T=m.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};const X=["Example","WithSelectedDate","WeekSelection","RangeSelection","MinMax","LocalizedFrench","MondayStart"];export{n as Example,s as LocalizedFrench,c as MinMax,m as MondayStart,r as RangeSelection,t as WeekSelection,l as WithSelectedDate,X as __namedExportsOrder,Q as default};
