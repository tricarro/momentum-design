import{S as P,U as j,a7 as D,k as h,n as A,u as M,P as E,c as U,B as C,I as u,R as Z,t as o}from"./iframe-B68zFh-R.js";import{a as V,B as F}from"./button.component-B8x0XBNW.js";import{L as W}from"./linksimple.component-D9Jg0cK5.js";import"./index-CcBRSnuj.js";import{i as x}from"./manifest-774oQsuf.js";import{c as Y,s as G}from"./commonArgTypes-BG7EqI50.js";import{h as K}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./button.utils-rNW36Ji7.js";import"./DataAriaLabelMixin-BaR4QREq.js";import"./index-DTrDRi1E.js";const q=P`
  :host {
    border: unset;
  }
...
`,H=[q,...j(!0)];var J=Object.defineProperty,R=(t,e,s,tt)=>{for(var i=void 0,f=t.length-1,m;f>=0;f--)(m=t[f])&&(i=m(e,s,i)||i);return i&&J(e,s,i),i};const b=class b extends V(W){constructor(){super(...arguments),this.size=D.SIZE}setSoftDisabled(e,s){s?e.setAttribute("aria-disabled","true"):e.removeAttribute("aria-disabled")}update(e){super.update(e),e.has("softDisabled")&&this.setSoftDisabled(this,this.softDisabled),e.has("size")&&this.setSize(this.size),e.has("variant")&&(this.setVariant(this.variant),this.setColor(this.color),this.setSize(this.size)),e.has("color")&&this.setColor(this.color),e.has("typeInternal")&&this.setSize(this.size),(e.has("prefixIcon")||e.has("postfixIcon"))&&this.inferButtonType()}renderAnchorContent(){return h`
    ...
    `}};b.styles=[...F.styles,...H];let n=b;R([A({type:Number,reflect:!0})],n.prototype,"size");R([A({type:Boolean,attribute:"soft-disabled",reflect:!0})],n.prototype,"softDisabled");const Q=M.constructTagName("buttonlink");n.register(Q);const{action:a}=__STORYBOOK_MODULE_ACTIONS__,X=t=>h`<div role="${Z.MAIN}">
    <mdc-buttonlink
      @click="${a("onclick")}"
      @keydown="${a("onkeydown")}"
      @focus="${a("onfocus")}"
...
}`,...(w=(N=d.parameters)==null?void 0:N.docs)==null?void 0:w.source}}};const xt=["Example","PillButtonLink","PillWithPrefixIcon","PillWithPostfixIcon","IconButtonLink"];export{r as Example,d as IconButtonLink,l as PillButtonLink,p as PillWithPostfixIcon,c as PillWithPrefixIcon,xt as __namedExportsOrder,ut as default};
