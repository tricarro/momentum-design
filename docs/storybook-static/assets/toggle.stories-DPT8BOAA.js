import{aE as x,U as B,J,K as Q,aT as y,k as g,t as i}from"./iframe-Bsgxabal.js";import{c as X,s as ee}from"./commonArgTypes-BG7EqI50.js";import{h as te,a as S}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,oe=e=>g`
  <div role="main">
    <mdc-toggle
      name="${i(e.name)}"
      value="${i(e.value)}"
...
`,se={title:"Components/toggle",tags:["autodocs"],component:"mdc-toggle",render:oe,argTypes:{size:{control:"inline-radio",options:Object.values(x)},checked:{control:"boolean"},disabled:{control:"boolean"},readonly:{control:"boolean"},"soft-disabled":{control:"boolean"},"control-type":{control:"select",options:[void 0,...B]},label:{control:"text"},"help-text":{control:"text"},"auto-focus-on-mount":{control:"boolean"},required:{control:"boolean"},name:{control:"text"},value:{control:"text"},"data-aria-label":{control:"text",description:"Aria label for the toggle component. Required for accessibility."},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(J)},"toggletip-strategy":{control:"select",options:Object.values(Q)},"info-icon-aria-label":{control:"text"},...te(["help-text-type","id","validation-message","validity","willValidate"]),...X,...ee}},a={args:{name:"toggleName",value:"toggleValue",label:"Toggle label",checked:!1,size:y.SIZE,disabled:!1,readonly:!1,"soft-disabled":!1,"help-text":""}},d={args:{...a.args,size:x.DEFAULT}},m={args:{...a.args,size:x.COMPACT}},u={args:{...a.args,"help-text":"helper text"}},p={args:{size:y.SIZE},render:e=>g`
...
}`,...(w=(F=m.parameters)==null?void 0:F.docs)==null?void 0:w.source}}};var L,q,V;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    'help-text': 'helper text'
  }
}`,...(V=(q=u.parameters)==null?void 0:q.docs)==null?void 0:V.source}}};var I,N,O;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE
  },
  render: args => html\`
  ...
  ...hideAllControls()
}`,...(G=(P=f.parameters)==null?void 0:P.docs)==null?void 0:G.source}}};var j,K,Y;v.parameters={...v.parameters,docs:{...(j=v.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
