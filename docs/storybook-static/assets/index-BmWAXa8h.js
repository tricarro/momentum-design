import{S as p,u as g,k as c,v as h,t as v,V as b,T as f,n as m}from"./iframe-B68zFh-R.js";import{d,b as y}from"./dialog.component-C7u-_JKG.js";import"./index-BmcSv-jK.js";const x=p`
  :host {
...
`,E=[x],S=g.constructTagName("announcementdialog"),N=["medium","large","xlarge","fullscreen"],T={SIZE:"medium"};var _=Object.defineProperty,D=Object.getOwnPropertyDescriptor,u=(l,t,r,a)=>{for(var e=a>1?void 0:a?D(t,r):t,i=l.length-1,o;i>=0;i--)(o=l[i])&&(e=(a?o(t,r,e):o(e))||e);return a&&e&&_(t,r,e),e};const s=class s extends d{get size(){var t,r;return(r=(t=this.responsiveSettingsContext)==null?void 0:t.value)!=null&&r.forceFullscreenDialog?"fullscreen":this.internalSize}set size(t){this.internalSize=t}constructor(){super(),this.internalSize=T.SIZE}connectedCallback(){super.connectedCallback(),this.variant=y.DEFAULT}renderHeader(){return c`${h}`}renderBody(){return c`
      <div part="body">
        <div part="illustration-container">
          <slot name="illustration-container">
            <mdc-illustration name="${v(this.illustration)}"></mdc-illustration>
          </slot>
        </div>
    ...
    `}};s.styles=[...d.styles,...E];let n=s;u([m({type:String,reflect:!0})],n.prototype,"illustration",2);u([m({type:String,reflect:!0})],n.prototype,"size",1);n.register(S);export{N as A,T as D};
