import{u as g,S as T,U as y,ab as A,k as a,v as s,T as f,V as x,R as h,C as v,n as o}from"./iframe-B68zFh-R.js";import{D as L}from"./DisabledMixin-Cqnt9CUs.js";import{K as S,a as N,A as m}from"./KeyDownHandledMixin-BiZdIgE3.js";const P=g.constructTagName("accordiongroup"),E={SMALL:"small",LARGE:"large"},R={BORDERLESS:"borderless",CONTAINED:"contained",STACKED:"stacked"},H={SIZE:E.SMALL,VARIANT:R.STACKED},V=g.constructTagName("accordionbutton"),c={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},D={DEFAULT:"default",BORDERLESS:"borderless"},I={LEADING:"leading",TRAILING:"trailing"},t={EXPANDED:!1,SIZE:E.SMALL,DATA_ARIA_LEVEL:3,VARIANT:D.DEFAULT,ICON_NAME:c.ARROW_UP,TOGGLE_POSITION:I.TRAILING},O=T`
  :host {
...
`,$=[O,...y(!0)];var _=Object.defineProperty,i=(b,e,n,k)=>{for(var d=void 0,l=b.length-1,u;l>=0;l--)(u=b[l])&&(d=u(e,n,d)||d);return d&&_(e,n,d),d};const p=class p extends S(N(L(v))){constructor(){super(...arguments),this.size=t.SIZE,this.variant=t.VARIANT,this.dataAriaLevel=t.DATA_ARIA_LEVEL,this.expanded=t.EXPANDED,this.togglePosition=t.TOGGLE_POSITION,this.headSectionId=`head-section-${A()}`,this.bodySectionId=`body-section-${A()}`}handleHeaderClick(){this.disabled||(this.expanded=!this.expanded,this.dispatchHeaderClickEvent())}click(){this.disabled||(super.click(),this.handleHeaderClick())}dispatchHeaderClickEvent(){const e=new CustomEvent("shown",{bubbles:!0,cancelable:!0,detail:{expanded:this.expanded}});this.dispatchEvent(e)}handleKeyDown(e){const n=this.getActionForKeyEvent(e);(n===m.ENTER||n===m.SPACE)&&(this.handleHeaderClick(),this.keyDownEventHandled())}renderIcon(e){return e?a`<mdc-icon name="${e}" length-unit="rem" size="1"></mdc-icon>`:s}renderHeadingText(){return this.headerText?a`<mdc-text
    ...
    `}getArrowIconName(){return this.disabled?c.ARROW_DOWN:this.expanded?c.ARROW_UP:c.ARROW_DOWN}renderBody(){return this.disabled?s:this.expanded?a`<div
      ...
      >
        <slot></slot>
      </div>`:s}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",`${this.disabled}`),e.has("dataAriaLevel")&&!this.dataAriaLevel&&(this.dataAriaLevel=t.DATA_ARIA_LEVEL),e.has("size")&&!this.size&&(this.size=t.SIZE),e.has("variant")&&!this.variant&&(this.variant=t.VARIANT),e.has("togglePosition")&&!this.togglePosition&&(this.togglePosition=t.TOGGLE_POSITION)}render(){return a` ${this.renderHeader()} ${this.renderBody()} `}};p.styles=[...v.styles,...$];let r=p;i([o({type:String,reflect:!0})],r.prototype,"size");i([o({type:String,reflect:!0})],r.prototype,"variant");i([o({type:Number,reflect:!0,attribute:"data-aria-level"})],r.prototype,"dataAriaLevel");i([o({type:Boolean,reflect:!0})],r.prototype,"expanded");i([o({type:String,reflect:!0,attribute:"header-text"})],r.prototype,"headerText");i([o({type:String,attribute:"prefix-icon"})],r.prototype,"prefixIcon");i([o({type:String,reflect:!0,attribute:"toggle-position"})],r.prototype,"togglePosition");export{r as A,H as D,E as S,I as T,D as V,V as a,P as b,R as c};
