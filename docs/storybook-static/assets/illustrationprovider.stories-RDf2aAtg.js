import{C as d,a2 as v,k as m,t as h,n as x,a3 as y}from"./iframe-B68zFh-R.js";import{p as f}from"./index-DcKjLdTd.js";import{h as g}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";var C=Object.defineProperty,P=(t,r,n,a)=>{for(var e=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(e=s(r,n,e)||e);return e&&C(r,n,e),e};class p extends d{constructor(){super(...arguments),this.illustrationProviderContext=f.consume({host:this,context:v.Context})}render(){var r,n,a,e,o;return m`
    ...
    `}}P([x({type:String,attribute:"illustration-name"})],p.prototype,"illustrationName");p.register("mdc-subcomponent-illustration");const $=t=>m`
...
}`,...(c=(u=i.parameters)==null?void 0:u.docs)==null?void 0:c.source}}};const N=["Example"];export{i as Example,N as __namedExportsOrder,_ as default};
