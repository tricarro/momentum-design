import{k as i,Q as n,K as lt,q as at}from"./iframe-B68zFh-R.js";import"./index-Cq9rD79r.js";import{c as st,s as ct}from"./commonArgTypes-BG7EqI50.js";import{h as ot}from"./utils-B5QUENNQ.js";import{L as s}from"./listitem.constants-CKsHLKpD.js";import"./index-BfiY_T-a.js";import"./index-BZVBFr71.js";import"./index-DYLHq5ML.js";import"./index-D6XkU7t1.js";import"./index-uWHJZHWu.js";import"./index-B8ihRXBI.js";import"./index-CcBRSnuj.js";import"./index-CmSaUzO7.js";import"./index-BpqxppdJ.js";import"./index-Bc01kZ-z.js";import"./index-BIug64jN.js";import"./index-BTazplaC.js";import"./index-BUEGE1H7.js";import"./index-DrDQ8qha.js";import"./index-yDK41FTK.js";import"./preload-helper-C1FmrZbK.js";import"./list.component-CIKerBTs.js";import"./ListNavigationMixin-DyNP5gzE.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./CaptureDestroyEventForChildElement-FTucl9bH.js";import"./IconNameMixin-BwwTHp8W.js";import"./index-DtrEhfhg.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./badge.constants-C3cosm6A.js";import"./button.component-B8x0XBNW.js";import"./button.utils-rNW36Ji7.js";import"./index-TehB3b43.js";import"./formfieldwrapper.constants-CnsEzOUD.js";import"./popover.constants-CHY_Bn1n.js";import"./statusmessage.constants-aI6TPone.js";import"./index-DTWIEuIB.js";import"./popover.component-TGZ1C38d.js";import"./BackdropMixin-r0_gKnDt.js";import"./FocusTrapMixin-BbIi7yxz.js";import"./index-RIOMtNYw.js";import"./DataAriaLabelMixin-BaR4QREq.js";import"./FormInternalsMixin-Ch7Ctk-8.js";import"./formfieldwrapper.component-BqCQR5FV.js";import"./chip.component-t3pcBsRl.js";import"./staticchip.component-0vrNMi_Z.js";import"./index-DTrDRi1E.js";import"./listitem.component-DiCj7Lkc.js";import"./toggle.constants-DjEJ-jFG.js";import"./ControlTypeMixin-ISbn_sfd.js";import"./index-C66Azp1h.js";import"./index-BzQX-a8H.js";import"./index-nuEjS9PO.js";import"./menuitemradio.constants-jfB185Vt.js";import"./menupopover.constants-DnLM0gLw.js";import"./menuitem.component-ErCE-0PC.js";import"./menuitemcheckbox.constants-DAVKpMYS.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,o=["Maria Simpson","Diana Rees","Fiona Wallace","Abigail Reid","Theresa Miller","Andrea Wright","Natalie Hunter","Bernadette Carr","Samantha Robertson","Deirdre Clark"],rt=t=>i` <mdc-list
  ...
  >
    ...
    ${n(o,l=>i`<mdc-listitem @click="${e("onclick")}" label="${l}" variant="${s.INSET_PILL}">
  ...
  </mdc-list>`,be={title:"Components/list",tags:["autodocs"],component:"mdc-list",render:rt,argTypes:{textPassedToListHeader:{control:"text",description:"Text to be rendered in the list header component. This is a control in storybook only."},"aria-label":{control:"text"},loop:{control:"select",options:["true","false"],table:{defaultValue:{summary:"true"}}},orientation:{control:"select",options:["vertical","horizontal"],table:{defaultValue:{summary:"vertical"}}},...ot(["itemsStore"]),...st,...ct}},d={args:{textPassedToListHeader:"Participants List","aria-label":"View all participants",orientation:"vertical"}},u={render:t=>i`
  ...
  `,args:{textPassedToListHeader:"Scrollable Participants List","aria-label":"View all participants"}},b={render:t=>{const l=a=>{const r=a.target.closest("mdc-listitem");r&&r.remove()},m=()=>{var c;const a=[...document.querySelector("mdc-list").querySelectorAll("mdc-listitem")];(c=a[a.length-1])==null||c.remove()};return i`
      <mdc-list aria-label="${t["aria-label"]}">
        ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
        ${n(o,a=>i`<mdc-listitem @click="${e("onclick")}" label="${a}" variant="${s.INSET_PILL}">
              <mdc-avatar
                slot="leading-controls"
    ...
    `}},g={args:{textPassedToListHeader:"Participants List","aria-label":"View all participants","initial-focus":o.length-1}},h={render:t=>{const l=at(),m=()=>{var T,I;const a=document.createElement("mdc-listitem");a.setAttribute("variant",s.INSET_PILL),a.setAttribute("label",`List Item ${(((T=l.value)==null?void 0:T.children.length)||0)+1}`);const c=document.createElement("mdc-button");c.setAttribute("slot","trailing-controls"),c.textContent="Action";const r=document.createElement("mdc-button");r.setAttribute("slot","trailing-controls"),r.textContent="Action 2",a.append(c,r),(I=l.value)==null||I.append(a)};return i`
      <mdc-list aria-label="${t["aria-label"]}" ${lt(l)}>
        ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
        ${n(o.slice(0,4),a=>i`<mdc-listitem label="${a}" variant="${s.INSET_PILL}">
              <mdc-avatar
                slot="leading-controls"
                initials="${[a.split(" ")[0][0],a.split(" ")[1][0]].join("")}"
              ></mdc-avatar>
    ...
    >
      ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
      ${n(new Array(5).fill(0).map(()=>[...o]).flat(),l=>l,l=>i`<mdc-listitem @click="${e("onclick")}" label="${l}" variant="${s.INSET_PILL}">
            <mdc-checkbox slot="leading-controls" data-aria-label="mock label"></mdc-checkbox>
            <mdc-avatar
              slot="leading-controls"
              initials="${[l.split(" ")[0][0],l.split(" ")[1][0]].join("")}"
  ...
  `},$={parameters:{docs:{description:{story:i`<mdc-text tagname="p" type="body-large-bold">Horizontal List Orientation</mdc-text>
    ...
    >
      ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
      ${n(o.slice(0,5),l=>i`<mdc-listitem
            @click="${e("onclick")}"
            label="${l}"
...
}`,...(it=(et=x.parameters)==null?void 0:et.docs)==null?void 0:it.source}}};const ge=["Example","ListWithDivider","ScrollableListWithSelect","ListWithRemovalElements","InitialFocusAtBottom","ExpandingList","ScrollingList","ListWithInteractiveElements","HorizontalOrientation","NestedList","ScrollableListWithLongListItems"];export{d as Example,h as ExpandingList,$ as HorizontalOrientation,g as InitialFocusAtBottom,u as ListWithDivider,L as ListWithInteractiveElements,b as ListWithRemovalElements,k as NestedList,x as ScrollableListWithLongListItems,p as ScrollableListWithSelect,v as ScrollingList,ge as __namedExportsOrder,be as default};
