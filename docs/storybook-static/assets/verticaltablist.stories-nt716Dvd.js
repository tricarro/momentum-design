import{S as A,R as I,k as i,u as E,Q as M}from"./iframe-B68zFh-R.js";import{L as p}from"./list.component-CIKerBTs.js";import{T as w}from"./TabListComponentMixin-Dfc6ydE_.js";import{c as O}from"./index-Ct3pm30D.js";import{c as _,s as L}from"./commonArgTypes-BG7EqI50.js";import{h as N}from"./utils-B5QUENNQ.js";import"./index-CcBRSnuj.js";import"./index-DYLHq5ML.js";import"./preload-helper-C1FmrZbK.js";import"./ListNavigationMixin-DyNP5gzE.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-CKsHLKpD.js";import"./CaptureDestroyEventForChildElement-FTucl9bH.js";import"./button.utils-rNW36Ji7.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./IconNameMixin-BwwTHp8W.js";import"./index-DTrDRi1E.js";import"./badge.constants-C3cosm6A.js";const G=A`
  :host {
...
`,P=[G],m=class m extends w(p){constructor(){super(...arguments),this.orientation="vertical"}isValidItem(e){return e.matches(`${O}:not([disabled])`)}onElementStoreUpdate(e,l,o){super.onElementStoreUpdate(e,l,o),l==="added"&&e.setAttribute("variant","line")}connectedCallback(){super.connectedCallback(),this.role=I.TABLIST,this.setAttribute("aria-orientation","vertical")}render(){return i`
  ...
  >
    ${M(z,e=>e.tabId,e=>i`<mdc-tab
          ...
          @click="${a("onclick")}"
        ></mdc-tab>`)}
  </mdc-verticaltablist>`,na={title:"Components/verticaltablist",tags:["autodocs"],component:"mdc-verticaltablist",render:B,argTypes:{"aria-label":{control:"text",description:"Label for the tab list used for accessibility. This is required for the component to be accessible."},"active-tab-id":{control:"select",description:"ID of the active tab. Defaults to the first tab if not provided.",options:z.map(t=>t.tabId)},...N(["itemsStore","orientation","loop","initial-focus"]),..._,...L}},c={args:{"aria-label":"Navigation tabs","active-tab-id":"messages"}},r={render:t=>i`
    <mdc-verticaltablist
      data-aria-label="${t["data-aria-label"]}"
      active-tab-id="${t["active-tab-id"]||""}"
      @change="${a("change")}"
  ...
  `,args:{"active-tab-id":"general"},argTypes:{...N(["active-tab-id"])}};var g,v,x;c.parameters={...c.parameters,docs:{...(g=c.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    'aria-label': 'Navigation tabs',
    'active-tab-id': 'messages'
  }
}`,...(x=(v=c.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};var u,y,h;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: args => html\`
    <mdc-verticaltablist
...
}`,...(C=(S=n.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};const la=["Example","TabsWithBadges","TextOnlyTabs","TabsWithPanels"];export{c as Example,r as TabsWithBadges,n as TabsWithPanels,d as TextOnlyTabs,la as __namedExportsOrder,na as default};
