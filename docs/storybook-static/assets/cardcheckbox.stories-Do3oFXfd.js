import{u as W,S as Q,U as J,R as ee,v as te,k as r,n as Z,V as N,Q as ae,t as i}from"./iframe-B68zFh-R.js";import{D as ie}from"./DisabledMixin-Cqnt9CUs.js";import{K as re,a as oe,T as ne,A as C}from"./KeyDownHandledMixin-BiZdIgE3.js";import{C as x}from"./card.component-B844fuvC.js";import"./index-CcBRSnuj.js";import"./index-TehB3b43.js";import{i as le}from"./manifest-774oQsuf.js";import{i as n}from"./imageFixtures-CD4avj2q.js";import{c as ce,s as se}from"./commonArgTypes-BG7EqI50.js";import{h as de,a as me}from"./utils-B5QUENNQ.js";import{V as be,O as f,D as t}from"./FooterMixin-DqFVjP7r.js";import"./index-CEMsGq5u.js";import"./preload-helper-C1FmrZbK.js";import"./index-DcKjLdTd.js";import"./index-DTrDRi1E.js";import"./formfieldwrapper.constants-CnsEzOUD.js";import"./popover.constants-CHY_Bn1n.js";import"./statusmessage.constants-aI6TPone.js";import"./link.constants-B54f1TYF.js";import"./index-D6XkU7t1.js";import"./button.component-B8x0XBNW.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./button.utils-rNW36Ji7.js";import"./index-DTWIEuIB.js";import"./popover.component-TGZ1C38d.js";import"./BackdropMixin-r0_gKnDt.js";import"./FocusTrapMixin-BbIi7yxz.js";import"./index-RIOMtNYw.js";import"./formfieldwrapper.component-BqCQR5FV.js";const ue=W.constructTagName("cardcheckbox"),v={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},o={CHECK:"check",CHECKBOX:"checkbox"},I={SELECTION_TYPE:o.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},he=Q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,pe=[he,...J()];var Ae=Object.defineProperty,q=(e,a,s,Te)=>{for(var l=void 0,E=e.length-1,k;E>=0;E--)(k=e[E])&&(l=k(a,s,l)||l);return l&&Ae(a,s,l),l};const y=class y extends re(oe(ie(ne(x)))){constructor(){super(),this.checked=!1,this.selectionType=I.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}handleKeyDown(a){const s=this.getActionForKeyEvent(a);s===C.ENTER&&(this.toggleChecked(),this.keyDownEventHandled(),a.preventDefault()),s===C.SPACE&&a.preventDefault()}toggleOnSpace(a){this.getActionForKeyEvent(a)===C.SPACE&&(a.preventDefault(),this.toggleChecked())}renderSelection(){const a=this.checked?v.CHECKED:v.DEFAULT;switch(this.selectionType){case o.CHECK:return r`<mdc-icon
        ...
        ></mdc-staticcheckbox>`;default:return te}}renderHeader(){return r`<div part="header">${this.renderIcon()} ${this.renderTitle()} ${this.renderSelection()}</div>`}click(){this.disabled||super.click()}render(){return r`
      ${this.renderImage()}
      <div part="body">
        ${this.renderHeader()}
    ...
    `}};y.styles=[...x.styles,...pe];let m=y;q([Z({type:Boolean,reflect:!0})],m.prototype,"checked");q([Z({type:String,attribute:"selection-type",reflect:!0})],m.prototype,"selectionType");m.register(ue);const{action:d}=__STORYBOOK_MODULE_ACTIONS__,ge=e=>r`<div role="main">
    <mdc-cardcheckbox
      @click="${d("onclick")}"
      @keydown="${d("onkeydown")}"
      @keyup="${d("onkeyup")}"
    ...
    >
  </div>`,ze={title:"Components/card/cardcheckbox",tags:["autodocs"],component:"mdc-cardcheckbox",render:ge,argTypes:{variant:{control:"select",options:Object.values(be)},orientation:{control:"select",options:Object.values(f)},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"select",options:Object.keys(le)},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text",description:"Defines an accessible label for screen readers. Required when using icon-only cards.",table:{category:"attributes"}},"selection-type":{control:"select",options:Object.values(o)},"title-tag-name":{control:"select",options:Object.values(N)},"subtitle-tag-name":{control:"select",options:Object.values(N)},...de(["children"]),...ce,...se}},c=r`<mdc-text slot="body" type="body-midsize-medium" tagname="span"
...
>`,b={args:{"card-title":"Title",subtitle:"Subtitle","image-src":n.card,"image-alt":"Image Alt","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,variant:t.VARIANT,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,"selection-type":o.CHECK,children:c}},u={args:{"card-title":"Title",subtitle:"Subtitle","image-src":n.card,"image-alt":"Image Alt","icon-name":"placeholder-bold","aria-label":"Aria Label","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"selection-type":o.CHECKBOX,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:f.HORIZONTAL,children:c}},h={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"aria-label":"Aria Label","selection-type":o.CHECK,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION,children:c}},p={args:{"image-src":n.card,"image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","selection-type":o.CHECK,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION}},A={args:{"card-title":"Title",subtitle:"Subtitle","image-src":n.card,"image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,"selection-type":o.CHECKBOX,checked:!1,disabled:!1,tabIndex:0,children:r`<div slot="before-body">
  ...
  `,...me()};var S,O,L;b.parameters={...b.parameters,docs:{...(S=b.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
...
}`,...(F=(D=u.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};var H,R,M;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'icon-name': 'placeholder-bold',
...
}`,...(M=(R=h.parameters)==null?void 0:R.docs)==null?void 0:M.source}}};var U,_,G;p.parameters={...p.parameters,docs:{...(U=p.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    'image-src': imageFixtures.card,
    'image-alt': 'Image Alt',
    'card-title': 'Title',
...
}`,...(G=(_=p.parameters)==null?void 0:_.docs)==null?void 0:G.source}}};var K,B,V;A.parameters={...A.parameters,docs:{...(K=A.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'image-src': imageFixtures.card,
  ...
  \`,
  ...hideAllControls()
}`,...(z=(j=T.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};const Ze=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInCheckboxGroup"];export{p as CardWithoutBody,h as CardWithoutImage,T as CardsInCheckboxGroup,g as ContentAfterBody,A as ContentBeforeBody,b as Example,u as HorizontalCard,Ze as __namedExportsOrder,ze as default};
