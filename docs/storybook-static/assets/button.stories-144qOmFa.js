import"./index-D6XkU7t1.js";import"./index-D0fh6WTE.js";import"./index-DpNS6zxS.js";import{i as x}from"./manifest-774oQsuf.js";import{B as y,P as ee,c as v,d as g,k as r,I as $,t as n}from"./iframe-B68zFh-R.js";import{c as ne,s as oe}from"./commonArgTypes-BG7EqI50.js";import"./button.component-B8x0XBNW.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./button.utils-rNW36Ji7.js";import"./index-CcBRSnuj.js";import"./preload-helper-C1FmrZbK.js";import"./index-DTrDRi1E.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,i=e=>r`<mdc-button
    @click="${o("onclick")}"
    @keydown="${o("onkeydown")}"
    @keyup="${o("onkeyup")}"
    @focus="${o("onfocus")}"
  ...
  >`,ve={title:"Components/button",tags:["autodocs"],component:"mdc-button",render:i,argTypes:{children:{description:"Text label for the button.",control:"text"},"prefix-icon":{control:"select",options:Object.keys(x)},"postfix-icon":{control:"select",options:Object.keys(x)},active:{control:"boolean"},"aria-label":{control:"text",description:"Defines an accessible label for screen readers. Required when using icon-only buttons.",table:{category:"attributes"}},disabled:{control:"boolean"},"soft-disabled":{control:"boolean"},variant:{control:"select",options:Object.values(y)},size:{control:"select",options:Object.values(ee)},color:{control:"select",options:Object.values(v)},type:{control:"select",options:Object.values(g)},name:{control:"text"},value:{control:"text"},ariaStateKey:{control:"text"},inverted:{control:"boolean"},"auto-focus-on-mount":{control:"boolean"},...ne,...oe}},t={args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:y.PRIMARY,size:ee[32],color:v.DEFAULT,type:g.BUTTON,role:"button",tabIndex:0,inverted:!1}},s={args:{...t.args}},l={render:e=>r`<div style="padding: 10px; background: var(--mds-color-theme-inverted-background-normal);">
      ...
      ${i(e)}
    </div>`,argTypes:{size:{options:Object.values($)},"aria-label":{description:"Aria label for the icon button. Required for accessibility."}},args:{...a.args,inverted:!0}},u={render:e=>i({...e,style:"width: 150px;"}),args:{...t.args,children:"Long text with icons"}},m={render:e=>i({...e,style:"width: 150px;"}),args:{...t.args,children:"Long text with icons","prefix-icon":"placeholder-bold"}},f={render:e=>r`<mdc-button
      @click="${o("onclick")}"
      @keydown="${o("onkeydown")}"
      @keyup="${o("onkeyup")}"
      @focus="${o("onfocus")}"
    ...
    >
      ...
      ${e.children}
    </mdc-button>`,args:{...t.args,children:"Loading..."}},b={render:e=>r`<mdc-button
      @click="${o("onclick")}"
      @keydown="${o("onkeydown")}"
      @keyup="${o("onkeyup")}"
      @focus="${o("onfocus")}"
