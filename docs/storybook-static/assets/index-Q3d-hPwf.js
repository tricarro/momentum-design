import{S as h,C as p,k as u,n as l}from"./iframe-B68zFh-R.js";import{p as v}from"./index-DcKjLdTd.js";import{e as d,b,f as g}from"./stepper.component-DAE3V5oa.js";const f=h`
  :host {
...
`,k=[f];var x=Object.defineProperty,m=(a,r,t,n)=>{for(var e=void 0,c=a.length-1,i;c>=0;c--)(i=a[c])&&(e=i(r,t,e)||e);return e&&x(r,t,e),e};const s=class s extends p{constructor(){super(...arguments),this.status=d.STATUS,this.orientation=d.ORIENTATION,this.stepperContext=v.consume({host:this,context:b.Context})}updated(r){var n;super.updated(r);const t=(n=this.stepperContext)==null?void 0:n.value;!t||!t.orientation||(this.orientation=t.orientation)}render(){return u` <div part="connector"></div> `}};s.styles=[...p.styles,...k];let o=s;m([l({type:String,reflect:!0})],o.prototype,"status");m([l({type:String,reflect:!0})],o.prototype,"orientation");o.register(g);
