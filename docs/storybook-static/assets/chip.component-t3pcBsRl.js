import{u as b,T as v,V as u,b as g,R as p,S as k,a6 as T,U as E,v as h,k as a,n as m}from"./iframe-B68zFh-R.js";import{I as f}from"./IconNameMixin-BwwTHp8W.js";import{B as S}from"./buttonsimple.component-DtR-0bQJ.js";import{C as y,S as O}from"./staticchip.component-0vrNMi_Z.js";const $=b.constructTagName("chip"),r={COLOR:y.DEFAULT,TEXT_TYPE:v.BODY_MIDSIZE_REGULAR,TAG_NAME:u.SPAN,SIZE:g[24],ROLE:p.BUTTON},_=k`
  :host {
    cursor: pointer;
    height: 1.5rem;
  }
...
`,A=[T,_,...E()];var I=Object.defineProperty,n=(t,d,s,L)=>{for(var o=void 0,e=t.length-1,i;e>=0;e--)(i=t[e])&&(o=i(d,s,o)||o);return o&&I(d,s,o),o};const l=class l extends f(S){constructor(){super(...arguments),this.color=r.COLOR}connectedCallback(){super.connectedCallback(),this.role=r.ROLE,this.size=r.SIZE,this.active=void 0,this.softDisabled=void 0}renderIcon(){return this.iconName?a` <mdc-icon part="icon" name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:h}render(){return a`
      ${this.renderIcon()}
