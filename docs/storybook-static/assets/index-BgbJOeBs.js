import{u as l,S as m,a6 as p,C as b,k as h,n,L as v}from"./iframe-B68zFh-R.js";const g=l.constructTagName("buttongroup"),y={40:40,32:32,28:28,24:24},f={HORIZONTAL:"horizontal",VERTICAL:"vertical"},z={PRIMARY:"primary",SECONDARY:"secondary"},a={SIZE:y[28],VARIANT:z.PRIMARY,ORIENTATION:f.HORIZONTAL},T=m`
  :host {
...
`,A=[p,T];var N=Object.defineProperty,e=(s,t,c,O)=>{for(var r=void 0,d=s.length-1,u;d>=0;d--)(u=s[d])&&(r=u(t,c,r)||r);return r&&N(t,c,r),r};const i=class i extends b{constructor(){super(...arguments),this.orientation=a.ORIENTATION,this.variant=a.VARIANT,this.size=a.SIZE,this.compact=!1}handleSlotChange(){this.buttons.forEach(t=>{t.setAttribute("size",this.size.toString()),t.setAttribute("variant",this.variant)})}updated(t){super.updated(t),(t.has("size")||t.has("variant"))&&this.handleSlotChange()}render(){return h`<div part="container"><slot @slotchange=${this.handleSlotChange}></slot></div>`}};i.styles=[...b.styles,...A];let o=i;e([n({type:String,reflect:!0})],o.prototype,"orientation");e([n({type:String,reflect:!0})],o.prototype,"variant");e([n({type:Number,reflect:!0})],o.prototype,"size");e([n({type:Boolean,reflect:!0})],o.prototype,"compact");e([v({selector:"mdc-button"})],o.prototype,"buttons");o.register(g);export{z as B,y as a,f as b};
