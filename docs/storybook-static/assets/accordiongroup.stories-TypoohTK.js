import{S as H,U as K,C as x,k as g,n as E,L as U,R as F,t as L}from"./iframe-B68zFh-R.js";import{T as J}from"./index-QAz7cBsP.js";import{D as d,a as P,b as Q,S as n,c as s}from"./accordionbutton.component-B95nmr0X.js";import"./index-D4trRibI.js";import"./index-BZVBFr71.js";import"./index-B8ihRXBI.js";import{c as X,s as tt}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";import"./index-D6XkU7t1.js";import"./button.component-B8x0XBNW.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./button.utils-rNW36Ji7.js";import"./index-CcBRSnuj.js";import"./index-DTrDRi1E.js";import"./index-BfiY_T-a.js";import"./IconNameMixin-BwwTHp8W.js";import"./index-DtrEhfhg.js";import"./chip.component-t3pcBsRl.js";import"./staticchip.component-0vrNMi_Z.js";const ot=H`
  :host {
...
`,at=[ot,...K()];var et=Object.defineProperty,l=(o,t,a,m)=>{for(var c=void 0,S=o.length-1,f;S>=0;S--)(f=o[S])&&(c=f(t,a,c)||c);return c&&et(t,a,c),c};const I=class I extends x{constructor(){super(),this.size=d.SIZE,this.variant=d.VARIANT,this.allowMultiple=!1,this.addEventListener("shown",this.handleAccordionExpanded)}handleAccordionExpanded(t){this.allowMultiple||[...this.accordionItems,...this.accordionButtonItems].forEach(a=>{a!==t.target&&a.hasAttribute("expanded")&&a.toggleAttribute("expanded")})}setChildrenAccordionAttributes(t,a){[...this.accordionItems].forEach(m=>{m.setAttribute(t,a)}),[...this.accordionButtonItems].forEach(m=>{m.setAttribute(t,a)})}updated(t){super.updated(t),t.has("size")&&(this.size||(this.size=d.SIZE),this.setChildrenAccordionAttributes("size",this.size)),t.has("variant")&&(this.variant||(this.variant=d.VARIANT),this.setChildrenAccordionAttributes("variant",this.variant))}render(){return g` <slot></slot> `}};I.styles=[...x.styles,...at];let i=I;l([E({type:String,reflect:!0})],i.prototype,"size");l([E({type:String,reflect:!0})],i.prototype,"variant");l([E({type:Boolean,reflect:!0,attribute:"allow-multiple"})],i.prototype,"allowMultiple");l([U({selector:J})],i.prototype,"accordionItems");l([U({selector:P})],i.prototype,"accordionButtonItems");i.register(Q);const e=g`Loreum impusm sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
...
`,A={args:{size:n.SMALL,variant:s.CONTAINED,"allow-multiple":!1},render:it};var N,y,T;r.parameters={...r.parameters,docs:{...(N=r.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    variant: DEFAULTS.VARIANT,
    'allow-multiple': false
  }
}`,...(T=(y=r.parameters)==null?void 0:y.docs)==null?void 0:T.source}}};var z,C,M;p.parameters={...p.parameters,docs:{...(z=p.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    ...Example.args,
...
}`,...(q=(Y=A.parameters)==null?void 0:Y.docs)==null?void 0:q.source}}};const Ct=["Example","StackedVariant","ContainedVariant","BorderlessVariant","SmallSize","LargeSize","MultiInteractiveAccordion"];export{b as BorderlessVariant,u as ContainedVariant,r as Example,v as LargeSize,A as MultiInteractiveAccordion,h as SmallSize,p as StackedVariant,Ct as __namedExportsOrder,zt as default};
