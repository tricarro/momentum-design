import{u as Z,R as j,S as M,U as F,k as f,v as K,n as g,t as o}from"./iframe-B68zFh-R.js";import{I as V}from"./IconNameMixin-BwwTHp8W.js";import{B as W}from"./buttonsimple.component-DtR-0bQJ.js";import{D as x,L as G}from"./linksimple.component-D9Jg0cK5.js";import"./index-CcBRSnuj.js";import{i as P}from"./manifest-774oQsuf.js";import{c as Y,s as q}from"./commonArgTypes-BG7EqI50.js";import{h as H}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./DataAriaLabelMixin-BaR4QREq.js";import"./index-DTrDRi1E.js";const J=Z.constructTagName("linkbutton"),s={12:12,14:14,16:16},r={SIZE:s[16],ROLE:j.BUTTON,INLINE:x.INLINE,INVERTED:x.INVERTED},Q=e=>{switch(e){case s[12]:return .75;case s[14]:return .875;default:return 1}},X=M`
  :host {
    gap: 0.25rem;
    cursor: pointer;
...
`,ee=[X,...F()];var te=Object.defineProperty,h=(e,t,y,ne)=>{for(var n=void 0,v=e.length-1,z;v>=0;v--)(z=e[v])&&(n=z(t,y,n)||n);return n&&te(t,y,n),n};const b=class b extends V(W){constructor(){super(...arguments),this.size=r.SIZE,this.inline=r.INLINE,this.inverted=r.INVERTED}connectedCallback(){super.connectedCallback(),this.active=void 0,this.role=r.ROLE}update(t){super.update(t),t.has("size")&&this.setSize(this.size)}setSize(t){this.setAttribute("size",Object.values(s).includes(t)?`${t}`:r.SIZE.toString())}render(){return f`
      <slot></slot>
      ${this.iconName?f` <mdc-icon name=${this.iconName} size=${Q(this.size)} length-unit="rem"></mdc-icon> `:K}
    `}};b.styles=[...G.styles,...ee];let a=b;h([g({type:Number,reflect:!0})],a.prototype,"size");h([g({type:Boolean,reflect:!0})],a.prototype,"inline");h([g({type:Boolean,reflect:!0})],a.prototype,"inverted");a.register(J);const{action:l}=__STORYBOOK_MODULE_ACTIONS__,C=e=>f`<mdc-linkbutton
    @click="${l("onclick")}"
    @keydown="${l("onkeydown")}"
    @focus="${l("onfocus")}"
    @blur="${l("onblur")}"
...
}`,...(R=(D=p.parameters)==null?void 0:D.docs)==null?void 0:R.source}}};const be=["Example","StandaloneLinkButton","StandaloneLinkButtonInverted","InlineLinkButton","InlineLinkButtonInverted"];export{d as Example,u as InlineLinkButton,p as InlineLinkButtonInverted,c as StandaloneLinkButton,m as StandaloneLinkButtonInverted,be as __namedExportsOrder,he as default};
