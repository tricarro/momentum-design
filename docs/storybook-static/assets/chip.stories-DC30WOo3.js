import"./index-B8ihRXBI.js";import{k as n,R as A,t as a}from"./iframe-B68zFh-R.js";import{i as g}from"./manifest-774oQsuf.js";import{c as C,s as E}from"./commonArgTypes-BG7EqI50.js";import{h as T,a as k}from"./utils-B5QUENNQ.js";import{C as e}from"./staticchip.component-0vrNMi_Z.js";import"./chip.component-t3pcBsRl.js";import"./IconNameMixin-BwwTHp8W.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./index-CcBRSnuj.js";import"./preload-helper-C1FmrZbK.js";import"./index-DTrDRi1E.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=o=>n` <mdc-chip
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @keyup="${r("onkeyup")}"
    @focus="${r("onfocus")}"
...
}`,...(u=(b=t.parameters)==null?void 0:b.docs)==null?void 0:u.source}}};var h,O,L;c.parameters={...c.parameters,docs:{...(h=c.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    color: COLOR.DEFAULT,
    label: 'Label',
    'icon-name': 'placeholder-bold',
...
}`,...(L=(O=c.parameters)==null?void 0:O.docs)==null?void 0:L.source}}};var f,$,y;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:'{\n  render: () => html` <div style="display: flex; gap: 0.5rem;" role="${ROLE.MAIN}">\n      ${Object.values(COLOR).map(color => html` <mdc-chip color="${color}" label="${color}"></mdc-chip> `)}\n    </div>`,\n  ...hideAllControls()\n}',...(y=($=s.parameters)==null?void 0:$.docs)==null?void 0:y.source}}};const Y=["Example","WithIcon","Disabled","AllColors"];export{s as AllColors,c as Disabled,l as Example,t as WithIcon,Y as __namedExportsOrder,B as default};
