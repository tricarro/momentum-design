import{Z as Ne,h as He,_ as a,j as l,k as o,K as w,t as B}from"./iframe-Bsgxabal.js";import{c as Fe,s as Me}from"./commonArgTypes-BG7EqI50.js";import{d as Ue}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:g}=__STORYBOOK_MODULE_ACTIONS__,d=(e,t,i)=>o`<mdc-dialog
    class="${e.class}"
    style="${e.style}"
    id="${e.id}"
    z-index="${e["z-index"]}"
...
`,qe=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
  ...
  `},ot=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
    ${c(e.triggerId,"Click me!",t)} ${d(e,Ye(),i)}
...
}`,...(V=(U=h.parameters)==null?void 0:U.docs)==null?void 0:V.source}}};var R,j,Y;v.parameters={...v.parameters,docs:{...(R=v.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'Size: Medium',
  args: {
    size: DIALOG_SIZE[1],
    ...commonProperties,
...
}`,...(Y=(j=v.parameters)==null?void 0:j.docs)==null?void 0:Y.source}}};var q,K,X;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: 'Size: Large',
  args: {
    size: DIALOG_SIZE[2],
    ...commonProperties,
