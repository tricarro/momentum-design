import{S as f,a6 as b,ab as g,v as i,k as a,B as u,t as y,C as x,n as r}from"./iframe-B68zFh-R.js";import{D as T}from"./DisabledMixin-Cqnt9CUs.js";import{D as e,M as d}from"./formfieldwrapper.constants-CnsEzOUD.js";import{a as v}from"./statusmessage.constants-aI6TPone.js";const $=f`
  :host {
...
`,I=[b,$],E=n=>v[n]||"";var A=Object.defineProperty,l=(n,o,p,S)=>{for(var s=void 0,h=n.length-1,m;h>=0;h--)(m=n[h])&&(s=m(o,p,s)||s);return s&&A(o,p,s),s};const c=class c extends T(x){constructor(){super(...arguments),this.inputId=`mdc-el-${g()}`,this.required=!1,this.helpTextType=e.VALIDATION,this.toggletipPlacement=e.TOGGLETIP_PLACEMENT,this.toggletipStrategy=e.TOGGLETIP_STRATEGY,this.readonly=!1,this.softDisabled=!1,this.shouldRenderLabel=!0}renderLabelElement(){return this.label?this.shouldRenderLabel?a`<label for="${this.inputId}" id="${e.HEADING_ID}" part="label">${this.label}</label>`:a` <mdc-text
          id="${e.HEADING_ID}"
          tagname="${d.TAGNAME}"
          type="${d.HEADER_TYPE}"
          part="label"
    ...
    `:i}renderLabel(){if(!this.label)return i;const o=`toggletip-trigger-${g()}`,p=this.disabled||this.softDisabled;return a`<div part="label-text">
