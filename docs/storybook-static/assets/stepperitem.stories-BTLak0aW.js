import{aH as t,aJ as a,k as g}from"./iframe-Bsgxabal.js";import{c as I,s as y}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const{action:p}=__STORYBOOK_MODULE_ACTIONS__,v=e=>g` <mdc-stepperitem
    @click=${p("onClick")}
    @keydown=${p("onKeyDown")}
    @keyup=${p("onKeyUp")}
    variant=${e.variant}
...
}`,...(b=(c=r.parameters)==null?void 0:c.docs)==null?void 0:b.source}}};var m,u,T;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    variant: VARIANT.INLINE,
...
}`,...(A=(N=o.parameters)==null?void 0:N.docs)==null?void 0:A.source}}};const $=["Example","Inline","Stacked","Error","LongText"];export{l as Error,r as Example,s as Inline,o as LongText,n as Stacked,$ as __namedExportsOrder,f as default};
