import{a6 as s,S as l,U as v,R as u,a7 as m,k as b,t as r,n as g,u as h}from"./iframe-B68zFh-R.js";import{a as p,A as y,D as f}from"./index-BfiY_T-a.js";import{I as k}from"./IconNameMixin-BwwTHp8W.js";import{B as S}from"./buttonsimple.component-DtR-0bQJ.js";const T=[s,l`
    :host {
  ...
  `,...v()];var $=Object.defineProperty,x=(i,a,c,z)=>{for(var o=void 0,e=i.length-1,d;e>=0;e--)(d=i[e])&&(o=d(a,c,o)||o);return o&&$(a,c,o),o};const n=class n extends p(k(S)){constructor(){super(...arguments),this.ariaLabel=null}connectedCallback(){super.connectedCallback(),this.active=void 0,this.disabled=void 0,this.softDisabled=void 0,this.role=u.BUTTON,this.type=m.TYPE}update(a){super.update(a),a.has("size")&&this.setSize(this.size)}setSize(a){this.setAttribute("size",Object.values(y).includes(a)?`${a}`:f.SIZE.toString())}render(){return b`
      ...
      <mdc-avatar
        ...
        src="${r(this.src)}"
      ></mdc-avatar>
    `}};n.styles=[...T];let t=n;x([g({type:String,attribute:"aria-label"})],t.prototype,"ariaLabel");const A=h.constructTagName("avatarbutton");t.register(A);
