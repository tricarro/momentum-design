import{u as b,a6 as u,S as v,k as t,R as f,ab as T,n as l}from"./iframe-B68zFh-R.js";import"./index-C66Azp1h.js";import{D as y}from"./DataAriaLabelMixin-BaR4QREq.js";import{V as o}from"./formfieldwrapper.constants-CnsEzOUD.js";import{F as m}from"./formfieldwrapper.component-BqCQR5FV.js";const A=b.constructTagName("progressbar"),n={DEFAULT:"default",INLINE:"inline"},V={VARIANT:n.DEFAULT,VALIDATION:o.DEFAULT},$=[u,v`
    :host {
  ...
  `];var x=Object.defineProperty,d=(c,r,a,h)=>{for(var e=void 0,i=c.length-1,g;i>=0;i--)(g=c[i])&&(e=g(r,a,e)||e);return e&&x(r,a,e),e};const p=class p extends y(m){constructor(){super(...arguments),this.variant=V.VARIANT,this.value="0",this.error=!1,this.renderProgressbar=()=>{const r=this.getValidationVariant(),a=this.clampedValue>0&&this.clampedValue<100,h=this.error?"100":`${this.clampedValue}`;return t`
      <div
    ...
    `}}connectedCallback(){super.connectedCallback(),this.id=`${A}-${T()}`,this.disabled=void 0,this.toggletipText=void 0,this.toggletipPlacement=void 0}get clampedValue(){const r=Number(this.value);return Number.isNaN(r)?0:Math.max(0,Math.min(100,r))}getValidationVariant(){return this.error?this.helpTextType=o.ERROR:this.clampedValue===100?this.helpTextType=o.SUCCESS:this.helpTextType=o.DEFAULT,this.helpTextType}render(){const r=this.variant===n.INLINE;return t`
      ${r?t`<div part="inline-label-container">${this.renderLabelElement()} ${this.renderProgressbar()}</div>`:t`
            <div part="label-container">
              ${this.renderLabelElement()}
              ${this.variant===n.DEFAULT&&this.label?t`<span part="percentage">${this.clampedValue}%</span>`:""}
            </div>
