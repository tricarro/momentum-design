import{D as i}from"./index-DpNS6zxS.js";import{a as h,k as e}from"./iframe-B68zFh-R.js";import{c as T,s as g}from"./commonArgTypes-BG7EqI50.js";import"./index-D6XkU7t1.js";import{B as U,a as N,b as w}from"./index-BgbJOeBs.js";import{a as x}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";import"./button.component-B8x0XBNW.js";import"./buttonsimple.component-DtR-0bQJ.js";import"./DisabledMixin-Cqnt9CUs.js";import"./KeyDownHandledMixin-BiZdIgE3.js";import"./index-DcKjLdTd.js";import"./button.utils-rNW36Ji7.js";import"./index-CcBRSnuj.js";import"./index-DTrDRi1E.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,E=o=>e` <mdc-animation
    @load="${a("load")}"
    @complete="${a("complete")}"
    @error="${a("error")}"
    name="${o.name}"
  ...
  ></mdc-animation>`,Z={title:"Components/animation",tags:["autodocs"],component:"mdc-animation",render:E,argTypes:{name:{control:"select",options:[...Object.keys(h),void 0]},src:{control:"text"},loop:{control:"text"},autoplay:{control:"boolean"},"aria-label":{control:"text"},"aria-labelledby":{control:"text"},...T,...g}},t={args:{name:"celebrate",src:"",loop:i.LOOP,autoplay:i.AUTO_PLAY,"aria-label":"","aria-labelledby":""}},n={render:o=>e`
    <mdc-button inverted>
      Like
      <mdc-animation
        slot="postfix"
...
}`,...(b=($=m.parameters)==null?void 0:$.docs)==null?void 0:b.source}}};const z=["Example","AnimationInButton","EmojiAnimationGroup","AnimationFromUrl"];export{m as AnimationFromUrl,n as AnimationInButton,r as EmojiAnimationGroup,t as Example,z as __namedExportsOrder,Z as default};
