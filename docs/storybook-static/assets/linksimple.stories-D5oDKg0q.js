import{L as O,T as _}from"./linksimple.component-D9Jg0cK5.js";import{k as L}from"./iframe-B68zFh-R.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./DataAriaLabelMixin-BaR4QREq.js";import"./DisabledMixin-Cqnt9CUs.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
...
}`,...(I=(T=l.parameters)==null?void 0:T.docs)==null?void 0:I.source}}};const D=["Example","StandaloneLink","StandaloneLinkInverted","InlineLink","InlineLinkInverted"];export{t as Example,i as InlineLink,l as InlineLinkInverted,o as StandaloneLink,a as StandaloneLinkInverted,D as __namedExportsOrder,M as default};
