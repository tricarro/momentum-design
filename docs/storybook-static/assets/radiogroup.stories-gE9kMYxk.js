import{W as C,k as c}from"./iframe-Bsgxabal.js";import{c as _,s as E}from"./commonArgTypes-BG7EqI50.js";import{h as P,a as W}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:q}=__STORYBOOK_MODULE_ACTIONS__,O=t=>c` <div role="main">
    <mdc-radiogroup
      name="${t.name}"
      label="${t.label}"
  ...
  `},d={render:()=>{let t="medium";const m=o=>{t=o.target.value};return c`
    ...
    `},...W()};var p,h,g;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
