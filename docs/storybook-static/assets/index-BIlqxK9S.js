...
`,f=[_],E=t=>{switch(t){case n.INFORMATIONAL:return c.INFORMATIONAL_ICON_NAME;case n.SUCCESS:return c.SUCCESS_ICON_NAME;case n.WARNING:return c.WARNING_ICON_NAME;case n.ERROR:return c.ERROR_ICON_NAME;default:return null}};var x=Object.defineProperty,b=(t,a,p,O)=>{for(var r=void 0,s=t.length-1,h;s>=0;s--)(h=t[s])&&(r=h(a,p,r)||r);return r&&x(a,p,r),r};const g=class g extends v{constructor(){super(...arguments),this.variant=i.VARIANT}renderIcon(a){return a?l`
    ...
    `}};g.styles=[...v.styles,...f];let e=g;b([m({type:String,reflect:!0})],e.prototype,"variant");b([m({type:String,reflect:!0})],e.prototype,"label");b([m({type:String,reflect:!0,attribute:"secondary-label"})],e.prototype,"secondaryLabel");e.register(A);export{n as B};
