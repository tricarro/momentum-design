import"./index-CcBRSnuj.js";import{u as g,S as h,k as p,C as m,n as e}from"./iframe-B68zFh-R.js";import{D as b}from"./DisabledMixin-Cqnt9CUs.js";const u=g.constructTagName("statictoggle"),v={DEFAULT:"default",COMPACT:"compact"},n={CHECKED:"check-bold",UNCHECKED:"cancel-bold"},f={compact:.75,default:1.25},y={SIZE:v.DEFAULT},E=[h`
    :host {
  ...
  `];var k=Object.defineProperty,r=(d,s,l,C)=>{for(var o=void 0,c=d.length-1,i;c>=0;c--)(i=d[c])&&(o=i(s,l,o)||o);return o&&k(s,l,o),o};const a=class a extends b(m){constructor(){super(...arguments),this.checked=!1,this.size=y.SIZE,this.readonly=!1,this.softDisabled=!1}render(){return p`
      <slot></slot>
      <div part="slider">
        <mdc-icon
