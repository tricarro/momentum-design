import{S as v,a6 as p,U as u,k as s,v as g,C as b,n as m}from"./iframe-B68zFh-R.js";import{B as k}from"./buttonsimple.component-DtR-0bQJ.js";import{I as f}from"./IconNameMixin-BwwTHp8W.js";import{V as o,D as c,T as w}from"./alertchip.constants-Cxt82Xm7.js";import"./index-CcBRSnuj.js";const x=v`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,y=[p,x,...u()],A=a=>({[o.ERROR]:"error-legacy-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.WARNING]:"warning-badge-filled"})[a];var T=Object.defineProperty,h=(a,t,l,I)=>{for(var r=void 0,n=a.length-1,d;n>=0;n--)(d=a[n])&&(r=d(t,l,r)||r);return r&&T(t,l,r),r};const i=class i extends f(k){constructor(){super(...arguments),this.variant=c.VARIANT}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=c.SIZE,this.role=c.ROLE}render(){return s`
