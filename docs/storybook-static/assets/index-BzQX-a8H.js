import"./index-CcBRSnuj.js";import{S as u,C as d,v as l,k as o,n as g}from"./iframe-B68zFh-R.js";import{D as r,a as p,T as v}from"./statusmessage.constants-aI6TPone.js";const f=u`
  :host {
...
`,y=[f];var E=Object.defineProperty,h=(n,t,m,x)=>{for(var e=void 0,a=n.length-1,c;a>=0;a--)(c=n[a])&&(e=c(t,m,e)||e);return e&&E(t,m,e),e};const i=class i extends d{constructor(){super(...arguments),this.severity=r.SEVERITY}renderIcon(){const t=p[this.severity||r.SEVERITY];return t?o`<mdc-icon part="icon" name="${t}"></mdc-icon>`:l}renderMessage(){return this.message?o`
    ...
    `}};i.styles=[...d.styles,...y];let s=i;h([g({type:String,reflect:!0})],s.prototype,"severity");h([g({type:String,reflect:!0})],s.prototype,"message");s.register(v);
